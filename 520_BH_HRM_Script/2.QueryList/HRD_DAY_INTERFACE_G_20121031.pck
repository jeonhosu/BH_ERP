  ...
  BEGIN
    ...
    OPEN P_CURSOR FOR
           ...
           , (-- 주간자 처리.
               SELECT DI.WORK_DATE
                     ...
                     , CASE 
                       ...
                       END +
                       CASE 
                         WHEN TRUNC(DECODE(DI.MODIFY_IN_YN, 'Y', O_DM.MODIFY_TIME, DI.CLOSE_TIME), 'MI') < DI.PLAN_CLOSE_TIME THEN 1
                         ELSE 0
      ...
      GROUP BY ROLLUP((
             ...
             , S_DI.SOB_ID
             , S_DI.ORG_ID))
      ORDER BY HRM_COMMON_G.GET_CODE_F(S_DI.JOB_CATEGORY_ID, S_DI.SOB_ID, S_DI.ORG_ID)
             , HF.SORT_NUM
             , HF.FLOOR_CODE
             , S_DI.WORK_TYPE_GROUP
             , S_DI.HOLY_TYPE
