...
/*RAISE_APPLICATION_ERROR(-20001, W_PERSON_ID || ' | '  || TO_CHAR(P_CHECK_OPEN_TIME, 'YYYY-MM-DD HH24:MI:SS') || 
                                ...
                                ' | ' ||  V_MODIFY_OPEN_YN || ' | ' || V_MODIFY_CLOSE_YN);*/
         ...
         UPDATE HRD_DAY_INTERFACE DI
            SET DI.DANGJIK_YN              = V_DANGJIK_YN
              , DI.ALL_NIGHT_YN            = V_ALL_NIGHT_YN
              , DI.NEXT_DAY_YN             = P_NEXT_DAY_YN
