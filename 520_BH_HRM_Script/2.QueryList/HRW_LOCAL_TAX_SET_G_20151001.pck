    ...
    BEGIN
      SELECT COUNT(DISTINCT MP.PERSON_ID) AS PERSON_COUNT
        ...
        FROM HRM_PERSON_MASTER PM
          , HRP_MONTH_PAYMENT MP
          , ( SELECT YA.PERSON_ID
                   , TRUNC(YA.SUBT_IN_TAX_AMT, -1) AS SUBT_IN_TAX_AMT  -- 정산소득세.
                   , TRUNC(YA.SUBT_LOCAL_TAX_AMT, -1) AS SUBT_LOCAL_TAX_AMT  -- 정산소득세.
                FROM HRM_PERSON_MASTER PM
      ...
      SELECT COUNT(DISTINCT RA.PERSON_ID) AS PERSON_COUNT
           ...
           , SUM(CASE
					         WHEN NVL((SELECT 'Y'
								   ...
								   ELSE TRUNC(NVL(RA.RESIDENT_TAX_AMOUNT, 0), -1) + TRUNC(NVL(RA.H_RESIDENT_TAX_AMOUNT, 0), -1)
  ...
  BEGIN
    ...
    BEGIN
      SELECT COUNT(DISTINCT RI.EARNER_ID) AS PERSON_COUNT
           ...
           , SUM(RI.LOCAL_TAX_AMT) AS LOCAL_TAX_AMOUNT
        INTO V_PERSON_COUNT
           , V_STD_TAX_AMT
           , V_LOCAL_TAX_AMT
