  ...
  BEGIN
    ...
    OPEN P_CURSOR FOR
      SELECT HA.YEAR_YYYY AS YEAR_YYYY
           ...
           , NVL(HA.FIX_IN_TAX_AMT, 0) AS FIX_TAX_AMT
  ...
  BEGIN
    ...
    OPEN P_CURSOR FOR
      SELECT NVL(HA.YEAR_YYYY, NULL) AS YEAR_YYYY
           ...
           , NVL(HA.FIX_IN_TAX_AMT, 0) AS FIX_TAX_AMT                       -- 결정세액 
           -- 결정세액 
           ...
           -- 비과세 상세     
           , (NVL(HA.NONTAX_OUTSIDE_AMT, 0) + NVL(HA.PRE_NT_OUTSIDE_AMT, 0)) AS NONTAX_OUTSIDE_AMT 
