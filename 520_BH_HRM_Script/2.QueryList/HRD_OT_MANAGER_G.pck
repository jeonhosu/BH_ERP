         ...
         AND ((W_ERROR_YN               = 'N' AND 1 = 1)
           OR (W_ERROR_YN               != 'N' 
             AND ((NVL(OM.REAL_OT_TIME, 0) < NVL(OTG.STD_OT_TIME, 0))
               OR (OM.HOLY_TYPE IN('2', '3') AND WC.OPEN_TIME < NVL(OM.OPEN_TIME, WC.OPEN_TIME))
               OR (OM.HOLY_TYPE IN('2', '3') AND NVL(OM.CLOSE_TIME, WC.CLOSE_TIME) < WC.CLOSE_TIME))))  
