...
-- [2011-10-28][2011-11-29]
   ...
   BEGIN
             ...
             IF P_AFTER_OT_DATE_START IS NOT NULL AND P_AFTER_OT_TIME_START IS NOT NULL THEN
                V_AFTER_OT_START := TO_DATE(TO_CHAR(P_AFTER_OT_DATE_START, 'YYYY-MM-DD') ||  ' ' || P_AFTER_OT_TIME_START, 'YYYY-MM-DD HH24:MI');
             END IF;
             IF P_AFTER_OT_DATE_END IS NOT NULL AND P_AFTER_OT_TIME_END IS NOT NULL THEN
                V_AFTER_OT_END   := TO_DATE(TO_CHAR(P_AFTER_OT_DATE_END, 'YYYY-MM-DD') ||  ' ' || P_AFTER_OT_TIME_END,   'YYYY-MM-DD HH24:MI');
             END IF;
