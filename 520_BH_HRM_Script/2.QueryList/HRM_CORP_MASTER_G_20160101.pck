  ...
  BEGIN
    ...
    SELECT HRM_CORP_MASTER_S1.NEXTVAL
      ...
      FROM DUAL;
		...
		( CORP_ID, CORP_CODE, CORP_NAME, CORP_NAME_S
    ...
    , RETIREMENT_PENSION_BANK, RETIREMENT_PENSION_ACCOUNT
		) VALUES
		( P_CORP_ID, P_CORP_CODE, P_CORP_NAME, P_CORP_NAME_S
    ...
    , P_RETIREMENT_PENSION_BANK, P_RETIREMENT_PENSION_ACCOUNT
		);
  END DATA_INSERT;
