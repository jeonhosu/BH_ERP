  ...
  BEGIN
    ...
    BEGIN
      SELECT COUNT(RA.PERSON_ID) AS PERSON_COUNT
           , SUM(NVL(RA.INCOME_TAX_AMOUNT, 0) + NVL(RA.H_INCOME_TAX_AMOUNT, 0)) AS INCOME_TAX_AMT
           , SUM(NVL(RA.RESIDENT_TAX_AMOUNT, 0) + NVL(RA.H_RESIDENT_TAX_AMOUNT, 0)) AS LOCAL_TAX_AMT
        INTO V_PERSON_COUNT
           , V_STD_TAX_AMT
           , V_LOCAL_TAX_AMT
