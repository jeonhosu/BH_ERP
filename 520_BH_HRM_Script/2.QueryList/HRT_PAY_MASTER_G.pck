CREATE OR REPLACE PACKAGE HRT_PAY_MASTER_G
AS
...
-- 급여마스터 대상 조회.
  PROCEDURE DATA_SELECT_PERSON
            ...
            , W_STD_YYYYMM                        IN HRT_PAY_MASTER_HEADER.START_YYYYMM%TYPE
            , W_PAY_TYPE                          IN HRT_PAY_MASTER_HEADER.PAY_TYPE%TYPE
...
-- 급여마스터 헤더 조회.
  PROCEDURE DATA_SELECT_HEADER
            ( P_CURSOR                            OUT TYPES.TCURSOR
            , W_CORP_ID                           IN HRT_PAY_MASTER_HEADER.CORP_ID%TYPE
            , W_STD_YYYYMM                        IN HRT_PAY_MASTER_HEADER.START_YYYYMM%TYPE
            , W_PAY_TYPE                          IN HRT_PAY_MASTER_HEADER.PAY_TYPE%TYPE
            , W_PERSON_ID                         IN HRT_PAY_MASTER_HEADER.PERSON_ID%TYPE
...
-- 급여마스터 라인조회-지급항목.
  PROCEDURE DATA_SELECT_ALLOWANCE
            ...
            , W_PAY_HEADER_ID                     IN HRT_PAY_MASTER_HEADER.PAY_HEADER_ID%TYPE
            );
...
-- PAY MASTER SELECT
  PROCEDURE PAY_MASTER_SELECT
            ...
            , W_STD_YYYYMM                        IN HRT_PAY_MASTER_HEADER.START_YYYYMM%TYPE
            , W_PAY_TYPE                          IN HRT_PAY_MASTER_HEADER.PAY_TYPE%TYPE
            , W_PAY_GRADE_ID                      IN HRT_PAY_MASTER_HEADER.PAY_GRADE_ID%TYPE
...
-- PAY MASTER SELECT(TERM)
  PROCEDURE PAY_MASTER_SELECT1
            ( P_CURSOR                            OUT TYPES.TCURSOR
            , W_CORP_ID                           IN HRT_PAY_MASTER_HEADER.CORP_ID%TYPE
            , W_START_YYYYMM                      IN HRT_PAY_MASTER_HEADER.START_YYYYMM%TYPE
            , W_END_YYYYMM                        IN HRT_PAY_MASTER_HEADER.END_YYYYMM%TYPE
            , W_PAY_TYPE                          IN HRT_PAY_MASTER_HEADER.PAY_TYPE%TYPE
            , W_PAY_GRADE_ID                      IN HRT_PAY_MASTER_HEADER.PAY_GRADE_ID%TYPE
            , W_DEPT_ID                           IN HRM_DEPT_MASTER.DEPT_ID%TYPE
            , W_PERSON_ID                         IN HRT_PAY_MASTER_HEADER.PERSON_ID%TYPE
...
-- PERSON INSERT(BLANK PROCEDURE)
  PROCEDURE PERSON_INSERT
            ( P_PERSON_ID        IN HRT_PAY_MASTER_HEADER.PERSON_ID%TYPE
            );
...
-- 급여마스터 헤더 저장(INSERT/UPDATE) 제어.
  PROCEDURE SAVE_PAY_HEADER
            ( P_PAY_HEADER_ID    OUT HRT_PAY_MASTER_HEADER.PAY_HEADER_ID%TYPE
            , P_PERSON_ID        IN HRT_PAY_MASTER_HEADER.PERSON_ID%TYPE
            , P_CORP_ID          IN HRT_PAY_MASTER_HEADER.CORP_ID%TYPE
            , P_STD_YYYYMM       IN HRT_PAY_MASTER_HEADER.START_YYYYMM%TYPE
            , P_PRINT_TYPE       IN HRT_PAY_MASTER_HEADER.PRINT_TYPE%TYPE
            , P_BANK_ID          IN HRT_PAY_MASTER_HEADER.BANK_ID%TYPE
            , P_BANK_ACCOUNTS    IN HRT_PAY_MASTER_HEADER.BANK_ACCOUNTS%TYPE
            , P_PAY_TYPE         IN HRT_PAY_MASTER_HEADER.PAY_TYPE%TYPE
            , P_PAY_GRADE_ID     IN HRT_PAY_MASTER_HEADER.PAY_GRADE_ID%TYPE
            , P_GRADE_STEP       IN HRT_PAY_MASTER_HEADER.GRADE_STEP%TYPE
            , P_CORP_CAR_YN      IN HRT_PAY_MASTER_HEADER.CORP_CAR_YN%TYPE
            , P_PAY_PROVIDE_YN   IN HRT_PAY_MASTER_HEADER.PAY_PROVIDE_YN%TYPE
            , P_BONUS_PROVIDE_YN IN HRT_PAY_MASTER_HEADER.BONUS_PROVIDE_YN%TYPE
            , P_YEAR_PROVIDE_YN  IN HRT_PAY_MASTER_HEADER.YEAR_PROVIDE_YN%TYPE
            , P_HIRE_INSUR_YN    IN HRT_PAY_MASTER_HEADER.HIRE_INSUR_YN%TYPE
            , P_DED_FAMILY_COUNT IN HRT_PAY_MASTER_HEADER.DED_FAMILY_COUNT%TYPE
            , P_DED_CHILD_COUNT  IN HRT_PAY_MASTER_HEADER.DED_CHILD_COUNT%TYPE
            , P_DESCRIPTION      IN HRT_PAY_MASTER_HEADER.DESCRIPTION%TYPE
            , P_SOB_ID           IN HRT_PAY_MASTER_HEADER.SOB_ID%TYPE
            , P_ORG_ID           IN HRT_PAY_MASTER_HEADER.ORG_ID%TYPE
            , P_USER_ID          IN HRT_PAY_MASTER_HEADER.CREATED_BY%TYPE 
            );
...
-- PAY_MASTER_HEADER_INSERT
  PROCEDURE PAY_HEADER_INSERT
            ...
            , P_PERSON_ID        IN HRT_PAY_MASTER_HEADER.PERSON_ID%TYPE
            , P_CORP_ID          IN HRT_PAY_MASTER_HEADER.CORP_ID%TYPE
            , P_START_YYYYMM     IN HRT_PAY_MASTER_HEADER.START_YYYYMM%TYPE
            , P_PRINT_TYPE       IN HRT_PAY_MASTER_HEADER.PRINT_TYPE%TYPE
            , P_BANK_ID          IN HRT_PAY_MASTER_HEADER.BANK_ID%TYPE
            , P_BANK_ACCOUNTS    IN HRT_PAY_MASTER_HEADER.BANK_ACCOUNTS%TYPE
            , P_PAY_TYPE         IN HRT_PAY_MASTER_HEADER.PAY_TYPE%TYPE
...
/*-- PAY_MASTER_HEADER_UPDATE.
  PROCEDURE PAY_HEADER_UPDATE
            ( P_PAY_HEADER_ID    IN HRT_PAY_MASTER_HEADER.PAY_HEADER_ID%TYPE
            , P_PERSON_ID        IN HRT_PAY_MASTER_HEADER.PERSON_ID%TYPE
            , P_CORP_ID          IN HRT_PAY_MASTER_HEADER.CORP_ID%TYPE
            , P_START_YYYYMM     IN HRT_PAY_MASTER_HEADER.START_YYYYMM%TYPE
            , P_PRINT_TYPE       IN HRT_PAY_MASTER_HEADER.PRINT_TYPE%TYPE
            ...
            , P_ORG_ID           IN HRT_PAY_MASTER_HEADER.ORG_ID%TYPE
            , P_USER_ID          IN HRT_PAY_MASTER_HEADER.CREATED_BY%TYPE
            , O_PAY_HEADER_ID    OUT HRT_PAY_MASTER_HEADER.PAY_HEADER_ID%TYPE
            );*/

---------------------------------------------------------------------------------------------------
-- 급여마스터 라인 저장.
  PROCEDURE SAVE_PAY_LINE
            ( P_PAY_LINE_ID      OUT HRT_PAY_MASTER_LINE.PAY_LINE_ID%TYPE
            , P_PAY_HEADER_ID    IN HRT_PAY_MASTER_LINE.PAY_HEADER_ID%TYPE
            ...
            , P_ENABLED_FLAG     IN HRT_PAY_MASTER_LINE.ENABLED_FLAG%TYPE
            , P_SOB_ID           IN HRT_PAY_MASTER_HEADER.SOB_ID%TYPE
            , P_ORG_ID           IN HRT_PAY_MASTER_HEADER.ORG_ID%TYPE
...
-- 급여마스터 라인 수정.
  PROCEDURE PAY_LINE_UPDATE
            ( W_PAY_LINE_ID      IN HRT_PAY_MASTER_LINE.PAY_LINE_ID%TYPE
            , P_ALLOWANCE_AMOUNT IN HRT_PAY_MASTER_LINE.ALLOWANCE_AMOUNT%TYPE
            , P_ENABLED_FLAG     IN HRT_PAY_MASTER_LINE.ENABLED_FLAG%TYPE
            , P_SOB_ID           IN HRT_PAY_MASTER_HEADER.SOB_ID%TYPE
            , P_USER_ID          IN HRT_PAY_MASTER_LINE.CREATED_BY%TYPE 
...
-- 급여마스터 백업.
  PROCEDURE PAY_HEADER_BACKUP
            ( W_PAY_HEADER_ID    IN HRT_PAY_MASTER_HEADER.PAY_HEADER_ID%TYPE
            , P_END_YYYYMM       IN HRT_PAY_MASTER_HEADER.START_YYYYMM%TYPE
            , P_USER_ID          IN HRT_PAY_MASTER_HEADER.CREATED_BY%TYPE 
            );    
...
-- 급여마스터 라인 복사.
  PROCEDURE PAY_LINE_COPY
            ( P_PAY_HEADER_ID     IN HRT_PAY_MASTER_LINE.PAY_HEADER_ID%TYPE
            , P_NEW_PAY_HEADER_ID IN HRT_PAY_MASTER_LINE.PAY_HEADER_ID%TYPE
            , P_SOB_ID            IN HRT_PAY_MASTER_HEADER.SOB_ID%TYPE
            , P_USER_ID           IN HRT_PAY_MASTER_LINE.CREATED_BY%TYPE 
            );
...
END HRT_PAY_MASTER_G;


 
/
CREATE OR REPLACE PACKAGE BODY HRT_PAY_MASTER_G
AS
/******************************************************************************/
/* PROJECT      : FPCB ERP
/* MODULE       : EAPP
/* PROGRAM NAME : HRT_PAY_MASTER_G
        ...
        FROM HRM_HISTORY_LINE HL  
          ...
          , (-- 급여 마스터 HEADER.
            SELECT PMH.PAY_HEADER_ID
             ...
             WHERE PMH.CORP_ID              = NVL(W_CORP_ID, PMH.CORP_ID)
        ...
        FROM HRM_HISTORY_LINE HL  
          ...
          , (-- 급여 마스터 HEADER.
            SELECT PMH.PAY_HEADER_ID
                 ...
                 , EAPP_USER_G.USER_NAME_F(PMH.LAST_UPDATED_BY) AS LAST_UPDATE_PERSON
              FROM HRT_PAY_MASTER_HEADER PMH
             WHERE PMH.START_YYYYMM         <= W_STD_YYYYMM
               AND (PMH.END_YYYYMM IS NULL OR PMH.END_YYYYMM >= W_STD_YYYYMM)
               AND PMH.PERSON_ID            = W_PERSON_ID
               AND PMH.PAY_TYPE             = NVL(W_PAY_TYPE, PMH.PAY_TYPE)
               AND PMH.PAY_GRADE_ID         = NVL(W_PAY_GRADE_ID, PMH.PAY_GRADE_ID)
    ...
    OPEN P_CURSOR3 FOR
      SELECT GL.ALLOWANCE_ID
       ...
       WHERE GH.GRADE_HEADER_ID       = GL.GRADE_HEADER_ID
         ...
         AND GH.CORP_ID               = NVL(W_CORP_ID, GH.CORP_ID)
...
-- 급여마스터 헤더 저장(INSERT/UPDATE) 제어.
  ...
  AS
    ...
    V_START_YYYYMM      HRT_PAY_MASTER_HEADER.START_YYYYMM%TYPE;
    V_END_YYYYMM        HRT_PAY_MASTER_HEADER.END_YYYYMM%TYPE;
    V_LAST_YN           HRT_PAY_MASTER_HEADER.LAST_YN%TYPE;
  BEGIN
...
-- PAY_MASTER_HEADER_INSERT
  ...
  BEGIN
    ...
    END;
    SELECT HRT_PAY_MASTER_HEADER_S1.NEXTVAL
      INTO P_PAY_HEADER_ID
      FROM DUAL;
    INSERT INTO HRT_PAY_MASTER_HEADER
    ( PAY_HEADER_ID
    , PERSON_ID 
    , CORP_ID 
    , START_YYYYMM 
...
-- 급여마스터 라인 저장.
  ...
  BEGIN
    ...
    -- 신규 생성.
      BEGIN
        SELECT HRT_PAY_MASTER_LINE_S1.NEXTVAL
        INTO P_PAY_LINE_ID
        FROM DUAL;
      EXCEPTION WHEN OTHERS THEN
        RAISE_APPLICATION_ERROR(ERRNUMS.Invalid_Sequence_Code, ERRNUMS.Invalid_Sequence_Desc);
      ...
      INSERT INTO HRT_PAY_MASTER_LINE
      ( PAY_LINE_ID
      , PAY_HEADER_ID 
      , ALLOWANCE_TYPE 
      , ALLOWANCE_ID 
...
-- 급여마스터 백업.
  ...
  BEGIN
    ...
    BEGIN
      UPDATE HRT_PAY_MASTER_HEADER PMH
...
-- 급여마스터 라인 카피.
  ...
  BEGIN
    ...
    , LAST_UPDATE_DATE 
    , LAST_UPDATED_BY)
    ( SELECT HRT_PAY_MASTER_LINE_S1.NEXTVAL AS PAY_LINE_ID
           , P_NEW_PAY_HEADER_ID
           , PML.ALLOWANCE_TYPE
           , PML.ALLOWANCE_ID
           , PML.ALLOWANCE_AMOUNT
...
-- 급여마스터 헤더 최종여부 리턴.
  ...
  AS
    V_LAST_YN           HRT_PAY_MASTER_HEADER.LAST_YN%TYPE := 'N';
  BEGIN
    BEGIN
      SELECT PMH.LAST_YN
        INTO V_LAST_YN
