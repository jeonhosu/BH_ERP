...
-- CORP INSERT..
  ...
  ( CORP_ID
  , OPERATING_UNIT_ID, OPERATING_UNIT_CODE, OPERATING_UNIT_NAME
  ...
  (P_CORP_ID
  , HRM_OPERATING_UNIT_S1.NEXTVAL, P_OPERATING_UNIT_CODE, P_OPERATING_UNIT_NAME
  ...
  BEGIN
    ...
    UPDATE HRM_OPERATING_UNIT OU
      SET OU.OPERATING_UNIT_NAME                                = P_OPERATING_UNIT_NAME
        ...
        , OU.ENABLED_FLAG                                       = P_ENABLED_FLAG
        , OU.EFFECTIVE_DATE_FR                                  = P_EFFECTIVE_DATE_FR
        , OU.EFFECTIVE_DATE_TO                                  = P_EFFECTIVE_DATE_TO 
