      ...
      SELECT  CASE
          ...
          , CASE
           ...
           , SUM(NVL(MD.D14, 0) + NVL(MD.D10, 0) + NVL(MD.D12, 0) + NVL(MD.D19, 0) + 
                 NVL(MD.D20, 0) + NVL(MD.D22, 0) + NVL(MD.D23, 0) ) AS D14  -- 기타공제(기타공제 + 전월정산액 + 경조사비 + 교육훈련비).
           ...
           , SUM(MD.D24) AS D24               -- 사용X
           , SUM(MD.D25) AS D25               -- 사용X
           , SUM(MD.D26) AS D26               -- 사용X
           , SUM(MD.D27) AS D27               -- 사용X
