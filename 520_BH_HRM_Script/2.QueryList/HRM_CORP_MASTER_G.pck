...
-- CORP INSERT..
  ...
  BEGIN
    ...
    , VENDOR_ID, BENEFIT_RATE
		...
		, P_DEPT_CONTROL_YN, P_DEPT_CONTROL_LEVEL, P_DUTY_CONTROL_YN, P_PAY_CONTROL_YN
		, P_DEFAULT_FLAG
  ...
  BEGIN
    UPDATE HRM_CORP_MASTER CM
     SET CM.CORP_NAME             = P_CORP_NAME
      ...
      , CM.DEPT_CONTROL_YN       = P_DEPT_CONTROL_YN
      , CM.DEPT_CONTROL_LEVEL    = P_DEPT_CONTROL_LEVEL
      , CM.DUTY_CONTROL_YN       = P_DUTY_CONTROL_YN
      , CM.PAY_CONTROL_YN        = P_PAY_CONTROL_YN
      , CM.DEFAULT_FLAG          = P_DEFAULT_FLAG
      , CM.ENABLED_FLAG          = P_ENABLED_FLAG
