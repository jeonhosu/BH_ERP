CREATE OR REPLACE PACKAGE HRP_PAYMENT_ADD_ALLOWANCE_G
AS

-- ADD_ALLOWANCE SELECT
  PROCEDURE DATA_SELECT
            ( P_CURSOR                            OUT TYPES.TCURSOR
            , W_CORP_ID                           IN HRP_PAYMENT_ADD_ALLOWANCE.CORP_ID%TYPE
            , W_PAY_YYYYMM                        IN HRP_PAYMENT_ADD_ALLOWANCE.PAY_YYYYMM%TYPE
            , W_WAGE_TYPE                         IN HRP_PAYMENT_ADD_ALLOWANCE.WAGE_TYPE%TYPE
            , W_ALLOWANCE_ID                      IN HRP_PAYMENT_ADD_ALLOWANCE.ALLOWANCE_ID%TYPE
            , W_PERSON_ID                         IN HRP_PAYMENT_ADD_ALLOWANCE.PERSON_ID%TYPE
            , W_SOB_ID                            IN HRP_PAYMENT_ADD_ALLOWANCE.SOB_ID%TYPE
            , W_ORG_ID                            IN HRP_PAYMENT_ADD_ALLOWANCE.ORG_ID%TYPE
            );

---------------------------------------------------------------------------------------------------
-- ADD_ALLOWANCE_INSERT
  PROCEDURE ADD_ALLOWANCE_INSERT
            ( P_ADD_ALLOWANCE_ID OUT HRP_PAYMENT_ADD_ALLOWANCE.ADD_ALLOWANCE_ID%TYPE
            , P_PERSON_ID        IN HRP_PAYMENT_ADD_ALLOWANCE.PERSON_ID%TYPE
            , P_CORP_ID          IN HRP_PAYMENT_ADD_ALLOWANCE.CORP_ID%TYPE
            , P_PAY_YYYYMM       IN HRP_PAYMENT_ADD_ALLOWANCE.PAY_YYYYMM%TYPE
            , P_WAGE_TYPE        IN HRP_PAYMENT_ADD_ALLOWANCE.WAGE_TYPE%TYPE
            , P_ALLOWANCE_ID     IN HRP_PAYMENT_ADD_ALLOWANCE.ALLOWANCE_ID%TYPE
            , P_ALLOWANCE_AMOUNT IN HRP_PAYMENT_ADD_ALLOWANCE.ALLOWANCE_AMOUNT%TYPE
            , P_TAX_YN           IN HRP_PAYMENT_ADD_ALLOWANCE.TAX_YN%TYPE
            , P_HIRE_INSUR_YN    IN HRP_PAYMENT_ADD_ALLOWANCE.HIRE_INSUR_YN%TYPE
            , P_CREATED_FLAG     IN HRP_PAYMENT_ADD_ALLOWANCE.CREATED_FLAG%TYPE
            , P_DESCRIPTION      IN HRP_PAYMENT_ADD_ALLOWANCE.DESCRIPTION%TYPE
            , P_SOB_ID           IN HRP_PAYMENT_ADD_ALLOWANCE.SOB_ID%TYPE
            , P_ORG_ID           IN HRP_PAYMENT_ADD_ALLOWANCE.ORG_ID%TYPE
            , P_USER_ID          IN HRP_PAYMENT_ADD_ALLOWANCE.CREATED_BY%TYPE 
            );

-- ADD_ALLOWANCE__UPDATE.
  PROCEDURE ADD_ALLOWANCE_UPDATE
            ( W_ADD_ALLOWANCE_ID IN HRP_PAYMENT_ADD_ALLOWANCE.ADD_ALLOWANCE_ID%TYPE
            , P_PERSON_ID        IN HRP_PAYMENT_ADD_ALLOWANCE.PERSON_ID%TYPE
            , P_CORP_ID          IN HRP_PAYMENT_ADD_ALLOWANCE.CORP_ID%TYPE
            , P_PAY_YYYYMM       IN HRP_PAYMENT_ADD_ALLOWANCE.PAY_YYYYMM%TYPE
            , P_WAGE_TYPE        IN HRP_PAYMENT_ADD_ALLOWANCE.WAGE_TYPE%TYPE
...
END HRP_PAYMENT_ADD_ALLOWANCE_G;


 
/
CREATE OR REPLACE PACKAGE BODY HRP_PAYMENT_ADD_ALLOWANCE_G
AS
/******************************************************************************/
/* PROJECT      : FPCB ERP
/* MODULE       : EAPP
/* PROGRAM NAME : HRP_PAYMENT_ADD_ALLOWANCE_G
...
-- ADD_ALLOWANCE_INSERT
  ...
  BEGIN
    ...
    BEGIN
      SELECT HRP_PAYMENT_ADD_ALLOWANCE_S1.NEXTVAL
    ...
    INSERT INTO HRP_PAYMENT_ADD_ALLOWANCE
    ( ADD_ALLOWANCE_ID
    , PERSON_ID 
    , CORP_ID 
    , PAY_YYYYMM 
...
-- ADD_ALLOWANCE__UPDATE.
  ...
  BEGIN
    ...
    UPDATE HRP_PAYMENT_ADD_ALLOWANCE
...
-- ADD_ALLOWANCE_DELETE.
  ...
  BEGIN
    BEGIN
      SELECT PAA.CORP_ID, PAA.PAY_YYYYMM, PAA.SOB_ID, PAA.ORG_ID 
        INTO V_CORP_ID, V_PAY_YYYYMM, V_SOB_ID, V_ORG_ID
        FROM HRP_PAYMENT_ADD_ALLOWANCE PAA
       WHERE PAA.ADD_ALLOWANCE_ID      = W_ADD_ALLOWANCE_ID
       ;
    EXCEPTION WHEN OTHERS THEN
    ...
    DELETE HRP_PAYMENT_ADD_ALLOWANCE
     WHERE ADD_ALLOWANCE_ID = W_ADD_ALLOWANCE_ID;
