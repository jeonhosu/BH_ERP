  ...
  BEGIN
    ...
    OPEN P_CURSOR FOR
      SELECT HA.YEAR_YYYY YEAR_YYYY,
             ...
             NVL(HA.LONG_HOUSE_PROF_AMT, 0) + NVL(HA.LONG_HOUSE_PROF_AMT_1, 0) + NVL(HA.LONG_HOUSE_PROF_AMT_2, 0) + NVL(HA.HOUSE_MONTHLY_AMT, 0) + 
             ...
             NVL(HA.LONG_HOUSE_PROF_AMT, 0) + NVL(HA.LONG_HOUSE_PROF_AMT_1, 0) + NVL(HA.LONG_HOUSE_PROF_AMT_2, 0) LONG_HOUSE_PROF_AMT,
