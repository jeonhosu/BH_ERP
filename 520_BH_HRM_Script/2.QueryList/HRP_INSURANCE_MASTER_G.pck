CREATE OR REPLACE PACKAGE HRP_INSURANCE_MASTER_G
AS

-- INSURANCE CHARGE SELECT
  PROCEDURE SELECT_INSUR_MASTER
            ( P_CURSOR                            OUT TYPES.TCURSOR
            , W_CORP_ID                           IN HRP_INSURANCE_MASTER.CORP_ID%TYPE
            , W_INSUR_YYYYMM                      IN VARCHAR2
            , W_INSUR_TYPE                        IN HRP_INSURANCE_MASTER.INSUR_TYPE%TYPE
            , W_DEPT_ID                           IN HRM_DEPT_MASTER.DEPT_ID%TYPE
            , W_PERSON_ID                         IN HRP_INSURANCE_MASTER.PERSON_ID%TYPE
            , W_SOB_ID                            IN HRP_INSURANCE_MASTER.SOB_ID%TYPE
            , W_ORG_ID                            IN HRP_INSURANCE_MASTER.ORG_ID%TYPE
            );

---------------------------------------------------------------------------------------------------
-- 보험관리-건강(보수월액), 국민(소득월액) 삽입.
  PROCEDURE INSERT_INSUR_MASTER
            ( P_PERSON_ID            IN HRP_INSURANCE_MASTER.PERSON_ID%TYPE
            , P_CORP_ID              IN HRP_INSURANCE_MASTER.CORP_ID%TYPE
            , P_INSUR_TYPE           IN HRP_INSURANCE_MASTER.INSUR_TYPE%TYPE
            , P_INSUR_YN             IN HRP_INSURANCE_MASTER.INSUR_YN%TYPE
            , P_INSUR_GRADE_STEP     IN HRP_INSURANCE_MASTER.INSUR_GRADE_STEP%TYPE
            , P_INSUR_AMOUNT         IN HRP_INSURANCE_MASTER.INSUR_AMOUNT%TYPE
            , P_CARE_INSUR_REDUCE_YN IN HRP_INSURANCE_MASTER.CARE_INSUR_REDUCE_YN%TYPE
            , P_GET_DATE             IN HRP_INSURANCE_MASTER.GET_DATE%TYPE
            , P_LOSS_DATE            IN HRP_INSURANCE_MASTER.LOSS_DATE%TYPE
            , P_INSUR_NO             IN HRP_INSURANCE_MASTER.INSUR_NO%TYPE
            , P_DESCRIPTION          IN HRP_INSURANCE_MASTER.DESCRIPTION%TYPE
            , P_SOB_ID               IN HRP_INSURANCE_MASTER.SOB_ID%TYPE
            , P_ORG_ID               IN HRP_INSURANCE_MASTER.ORG_ID%TYPE
            , P_USER_ID              IN HRP_INSURANCE_MASTER.CREATED_BY%TYPE 
            );
...
END HRP_INSURANCE_MASTER_G;
/
CREATE OR REPLACE PACKAGE BODY HRP_INSURANCE_MASTER_G
AS
/******************************************************************************/
/* PROJECT      : FPCB ERP
/* MODULE       : EAPP
/* PROGRAM NAME : HRP_INSURANCE_MASTER_G
        ...
        FROM HRM_HISTORY_LINE HL
          ...
          , (-- 보험관리.
            SELECT IM.PERSON_ID
                 ...
                 , IM.INSUR_NO
                 , IM.DESCRIPTION
              FROM HRP_INSURANCE_MASTER IM
             WHERE IM.CORP_ID               = W_CORP_ID
...
-- 보험관리-건강(보수월액), 국민(소득월액) 삽입.
  ...
  BEGIN
    INSERT INTO HRP_INSURANCE_MASTER
    ( PERSON_ID
    , CORP_ID 
    , INSUR_TYPE 
    , INSUR_YN 
