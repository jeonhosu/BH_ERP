...
--C1 ------------------------------------------------------------------------------------
        FOR C1 IN ( SELECT 
                       ...
                       || LPAD(NVL(YA.CHILD_DED_COUNT, 0), 2, 0) -- 75.자녀양육비공제인원;
                        ...
                        || LPAD(NVL(YA.TD_CHILD_RAISE_DED_CNT, 0), 10, 0) -- 118.58-가 자녀세액공제인원;
                        || LPAD(NVL(YA.TD_CHILD_RAISE_DED_AMT, 0), 10, 0) -- 119.58-가 자녀세액공제;
                        || LPAD(NVL(YA.TD_CHILD_6_UNDER_DED_CNT, 0), 10, 0) -- 120.58-나 6세이하 자녀세액공제인원;
                        || LPAD(NVL(YA.TD_CHILD_6_UNDER_DED_AMT, 0), 10, 0) -- 121.58-나 6세이하 자녀세액공제;
                        || LPAD(NVL(YA.TD_BIRTH_DED_CNT, 0), 10, 0) -- 122.58-다 출생.입양 자녀세액공제인원;
