...
-- 계정잔액명세 잔액 생성.
    ...
    LOOP 
      FOR C1 IN ( -- 계정잔액명세 계정 조회.
                  ...
                  WHERE BA.ACCOUNT_CONTROL_ID     = AC.ACCOUNT_CONTROL_ID
                    ...
                    AND BA.EFFECTIVE_DATE_FR      <= W_GL_DATE_FR + B1
                    AND (BA.EFFECTIVE_DATE_TO IS NULL OR BA.EFFECTIVE_DATE_TO >= W_GL_DATE_FR + B1)
                  )
      LOOP
  ---------------------------------------------------------------------------------------------------
        -- 당일 금액 초기화.
        ...
        WHERE BS.GL_DATE            = W_GL_DATE_FR + B1
        ...
        WHERE BSS.GL_DATE             = W_GL_DATE_FR + B1
  ...
  ---------------------------------------------------------------------------------------------------
        ...
        FOR C2 IN ( SELECT BS.ACCOUNT_CONTROL_ID
                    ...
                    WHERE BS.GL_DATE            = W_GL_DATE_FR + B1 - 1
                      AND BS.GL_DATE_SEQ        = 1
                      AND BS.ACCOUNT_CONTROL_ID = C1.ACCOUNT_CONTROL_ID
                      AND BS.SOB_ID             = C1.SOB_ID
                  )
  ...
  ---------------------------------------------------------------------------------------------------
        FOR C2 IN ( -- 전표내역 조회
                    ...
                    WHERE SH.SLIP_HEADER_ID           = SL.SLIP_HEADER_ID
                      ...
                      AND SH.GL_DATE                  = W_GL_DATE_FR + B1
