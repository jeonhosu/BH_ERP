    ...
    OPEN P_CURSOR FOR
      ...
      WHERE PM.DEPT_ID                  = DM.DEPT_ID
        ...
        AND ((W_YEAR_EMPLOYE_TYPE       IS NULL AND 1 =1)
          OR (W_YEAR_EMPLOYE_TYPE       != '20' AND (PM.RETIRE_DATE > V_STD_DATE OR PM.RETIRE_DATE IS NULL))
          OR (W_YEAR_EMPLOYE_TYPE       = '20' AND (PM.RETIRE_DATE BETWEEN TRUNC(V_STD_DATE, 'YEAR') AND V_STD_DATE)))
