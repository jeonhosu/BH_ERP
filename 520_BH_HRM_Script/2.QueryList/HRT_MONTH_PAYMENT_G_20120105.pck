CREATE OR REPLACE PACKAGE HRT_MONTH_PAYMENT_G
AS
...
-- 월급여 자료 SELECT(기간별)
  PROCEDURE SELECT_SPREAD_PERIOD
            ( P_CURSOR1                           OUT TYPES.TCURSOR1
            , W_CORP_ID                           IN HRT_MONTH_PAYMENT.CORP_ID%TYPE
            , W_PAY_YYYYMM_FR                     IN HRT_MONTH_PAYMENT.PAY_YYYYMM%TYPE
            , W_PAY_YYYYMM_TO                     IN HRT_MONTH_PAYMENT.PAY_YYYYMM%TYPE
            , W_WAGE_TYPE                         IN HRT_MONTH_PAYMENT.WAGE_TYPE%TYPE
            , W_PERSON_ID                         IN HRT_MONTH_PAYMENT.PERSON_ID%TYPE
            , W_DEPT_ID                           IN HRT_MONTH_PAYMENT.DEPT_ID%TYPE
            , W_PAY_GRADE_ID                      IN HRT_MONTH_PAYMENT.PAY_GRADE_ID%TYPE
...
-- 월급여 자료 수정.
  PROCEDURE MONTH_PAYMENT_UPDATE
            ( W_MONTH_PAYMENT_ID    IN HRT_MONTH_PAYMENT.MONTH_PAYMENT_ID%TYPE
            , P_NATIONAL_PENSION    IN HRT_MONTH_PAYMENT.NATIONAL_PENSION%TYPE
            , P_HEALTH_INSUR        IN HRT_MONTH_PAYMENT.HEALTH_INSUR%TYPE
            , P_UNEMPLOYMENT_INSUR  IN HRT_MONTH_PAYMENT.UNEMPLOYMENT_INSUR%TYPE
            , P_SAFETY_INSUR        IN HRT_MONTH_PAYMENT.SAFETY_INSUR%TYPE
            , P_DESCRIPTION         IN HRT_MONTH_PAYMENT.DESCRIPTION%TYPE
            , P_USER_ID             IN HRT_MONTH_PAYMENT.CREATED_BY%TYPE 
            );
...
-- 급상여 지급내역 조회 / 삽입 / 수정.
  PROCEDURE MONTH_ALLOWANCE_SELECT
            ( P_CURSOR1                           OUT TYPES.TCURSOR1
            , W_CORP_ID                           IN HRT_MONTH_ALLOWANCE.CORP_ID%TYPE
            , W_PAY_YYYYMM                        IN HRT_MONTH_ALLOWANCE.PAY_YYYYMM%TYPE
            , W_WAGE_TYPE                         IN HRT_MONTH_ALLOWANCE.WAGE_TYPE%TYPE
            , W_PERSON_ID                         IN HRT_MONTH_ALLOWANCE.PERSON_ID%TYPE
            , W_SOB_ID                            IN HRT_MONTH_ALLOWANCE.SOB_ID%TYPE
            , W_ORG_ID                            IN HRT_MONTH_ALLOWANCE.ORG_ID%TYPE
            );
            
-- 월급여 지급항목 INSERT
  PROCEDURE MONTH_ALLOWANCE_INSERT
            ( P_PERSON_ID        IN HRT_MONTH_ALLOWANCE.PERSON_ID%TYPE
            , P_PAY_YYYYMM       IN HRT_MONTH_ALLOWANCE.PAY_YYYYMM%TYPE
            , P_WAGE_TYPE        IN HRT_MONTH_ALLOWANCE.WAGE_TYPE%TYPE
            , P_CORP_ID          IN HRT_MONTH_ALLOWANCE.CORP_ID%TYPE
            , P_ALLOWANCE_ID     IN HRT_MONTH_ALLOWANCE.ALLOWANCE_ID%TYPE
            , P_ALLOWANCE_AMOUNT IN HRT_MONTH_ALLOWANCE.ALLOWANCE_AMOUNT%TYPE
            , P_MONTH_PAYMENT_ID IN HRT_MONTH_ALLOWANCE.MONTH_PAYMENT_ID%TYPE
            , P_SOB_ID           IN HRT_MONTH_ALLOWANCE.SOB_ID%TYPE
            , P_ORG_ID           IN HRT_MONTH_ALLOWANCE.ORG_ID%TYPE
            , P_USER_ID          IN HRT_MONTH_ALLOWANCE.CREATED_BY%TYPE 
            );

-- 월급여 지급항목 UPDATE.
  PROCEDURE MONTH_ALLOWANCE_UPDATE
            ( W_MONTH_PAYMENT_ID IN HRT_MONTH_ALLOWANCE.MONTH_PAYMENT_ID%TYPE
            , W_ALLOWANCE_ID     IN HRT_MONTH_ALLOWANCE.ALLOWANCE_ID%TYPE
            , P_ALLOWANCE_AMOUNT IN HRT_MONTH_ALLOWANCE.ALLOWANCE_AMOUNT%TYPE
            , W_SOB_ID           IN HRT_MONTH_ALLOWANCE.SOB_ID%TYPE
            , W_ORG_ID           IN HRT_MONTH_ALLOWANCE.ORG_ID%TYPE
            , P_USER_ID          IN HRT_MONTH_ALLOWANCE.CREATED_BY%TYPE
...
-- 급상여 공제내역 조회 / 삽입 / 수정.
  PROCEDURE MONTH_DEDUCTION_SELECT
            ...
            , W_CORP_ID                           IN HRT_MONTH_DEDUCTION.CORP_ID%TYPE
            , W_PAY_YYYYMM                        IN HRT_MONTH_DEDUCTION.PAY_YYYYMM%TYPE
            , W_WAGE_TYPE                         IN HRT_MONTH_DEDUCTION.WAGE_TYPE%TYPE
            , W_PERSON_ID                         IN HRT_MONTH_DEDUCTION.PERSON_ID%TYPE
            , W_SOB_ID                            IN HRT_MONTH_DEDUCTION.SOB_ID%TYPE
            , W_ORG_ID                            IN HRT_MONTH_DEDUCTION.ORG_ID%TYPE
            );
            
-- 월급여 공제항목 INSERT
  PROCEDURE MONTH_DEDUCTION_INSERT
            ( P_PERSON_ID        IN HRT_MONTH_DEDUCTION.PERSON_ID%TYPE
            , P_PAY_YYYYMM       IN HRT_MONTH_DEDUCTION.PAY_YYYYMM%TYPE
            , P_WAGE_TYPE        IN HRT_MONTH_DEDUCTION.WAGE_TYPE%TYPE
            , P_CORP_ID          IN HRT_MONTH_DEDUCTION.CORP_ID%TYPE
            , P_DEDUCTION_ID     IN HRT_MONTH_DEDUCTION.DEDUCTION_ID%TYPE
            , P_DEDUCTION_AMOUNT IN HRT_MONTH_DEDUCTION.DEDUCTION_AMOUNT%TYPE
            , P_MONTH_PAYMENT_ID IN HRT_MONTH_DEDUCTION.MONTH_PAYMENT_ID%TYPE
            , P_SOB_ID           IN HRT_MONTH_DEDUCTION.SOB_ID%TYPE
            , P_ORG_ID           IN HRT_MONTH_DEDUCTION.ORG_ID%TYPE
            , P_USER_ID          IN HRT_MONTH_DEDUCTION.CREATED_BY%TYPE 
            );

-- 월급여 공제항목 UPDATE.
  PROCEDURE MONTH_DEDUCTION_UPDATE
            ( W_MONTH_PAYMENT_ID IN HRT_MONTH_DEDUCTION.MONTH_PAYMENT_ID%TYPE
            , W_DEDUCTION_ID     IN HRT_MONTH_DEDUCTION.DEDUCTION_ID%TYPE
            , P_DEDUCTION_AMOUNT IN HRT_MONTH_DEDUCTION.DEDUCTION_AMOUNT%TYPE
            , W_SOB_ID           IN HRT_MONTH_DEDUCTION.SOB_ID%TYPE
            , W_ORG_ID           IN HRT_MONTH_DEDUCTION.ORG_ID%TYPE
            , P_USER_ID          IN HRT_MONTH_DEDUCTION.CREATED_BY%TYPE
...
-- 지급/공제 합계 처리.
  PROCEDURE PAYMENT_SUMMARY_UPDATE
            ( P_MONTH_PAYMENT_ID  IN HRT_MONTH_PAYMENT.MONTH_PAYMENT_ID%TYPE
...
END HRT_MONTH_PAYMENT_G;


 
/
CREATE OR REPLACE PACKAGE BODY HRT_MONTH_PAYMENT_G
AS
/******************************************************************************/
/* PROJECT      : FPCB ERP
/* MODULE       : EAPP
/* PROGRAM NAME : HRT_MONTH_PAYMENT_G
    ...
    OPEN P_CURSOR1 FOR
      SELECT  CASE
          ...
          , CASE
           ...
           , SUM(/*CASE 
                  WHEN MP.PAY_TYPE IN('1', '3') THEN */HRT_PAYMENT_G_SET.BASIC_AMOUNT_F(MP.PAY_YYYYMM, MP.PERSON_ID, MP.SOB_ID, MP.ORG_ID)
                  /*ELSE 0
                 END*/) AS BAISC_AMOUNT
           , SUM(CASE 
                  WHEN MP.PAY_TYPE IN('2') THEN HRT_PAYMENT_G_SET.BASIC_AMOUNT_F(MP.PAY_YYYYMM, MP.PERSON_ID, MP.SOB_ID, MP.ORG_ID)
                  ELSE 0
                 END) AS BAISC_DAILY_AMOUNT
           , SUM(CASE 
                  WHEN MP.PAY_TYPE IN('4') THEN HRT_PAYMENT_G_SET.BASIC_AMOUNT_F(MP.PAY_YYYYMM, MP.PERSON_ID, MP.SOB_ID, MP.ORG_ID)
                  ELSE 0
           ...
           , 0 /*SUM(MA.A05)*/ AS A05               -- 사용X
           , SUM(MA.A06) AS A06               -- 자격수당.
           , SUM(NVL(MA.A07, 0) + NVL(MA.A15, 0)) AS A07  -- 기타수당(기타수당 + 야간당직).
           , 0 /*SUM(MA.A08)*/ AS A08               -- 가족수당X.
           ...
           , 0 /*SUM(MA.A23)*/ AS A23               -- 사용X
           , SUM(MA.A24) AS A24               -- 자기개발수당.
           , SUM(MA.A25) AS A25               -- 차량유지비.
           , SUM(MA.A26) AS A26               -- 주휴수당.
           , 0 /*SUM(MA.A27)*/ AS A27               -- 휴일근무장려금 - X.
           , 0 /*SUM(MA.A28)*/ AS A28               -- 연휴근무격려금 - X.
           , 0 /*SUM(MA.A29)*/ AS A29               -- 사용X
           , 0 /*SUM(MA.A30)*/ AS A30               -- 사용X
           , SUM(MA.A31) AS A31               -- 복지수당.
           , SUM(MA.A32) AS A32               -- 육아수당.
           , SUM(MA.A33) AS A33               -- 식대.
           , SUM(MA.A34) AS A34               -- 연장II
           , SUM(MA.A35) AS A35               -- 관리직특근수당.
           , 0 /*SUM(MA.A36)*/ AS A36               -- 사용X
           , 0 /*SUM(MA.A37)*/ AS A37               -- 사용X
           , 0 /*SUM(MA.A38)*/ AS A38               -- 사용X
           , 0 /*SUM(MA.A39)*/ AS A39               -- 사용X
           ...
           , 0 /*SUM(MD.D12)*/ AS D12               -- 사원증발급비.
           , SUM(MD.D13) AS D13                -- 기숙사비.
           , SUM(NVL(MD.D14, 0) + NVL(MD.D10, 0)) AS D14                -- 기타공제(기타공제 + 전월정산액).
           , SUM(MD.D15) AS D15                -- 정산소득세.
           , SUM(MD.D16) AS D16                -- 정산주민세.
           , 0 /*SUM(MD.D17)*/ AS D17               -- 정산농특세.
           , 0 /*SUM(MD.D18)*/ AS D18               -- 사용X
           , 0 /*SUM(MD.D19)*/ AS D19               -- 사용X
           , 0 /*SUM(MD.D20)*/ AS D20               -- 사용X
           , SUM(MD.D21) AS D21                -- 신용보증보험료.
           , 0 /*SUM(MD.D22)*/ AS D22               -- 사용X
           , 0 /*SUM(MD.D23)*/ AS D23               -- 사용X
           , 0 /*SUM(MD.D24)*/ AS D24               -- 사용X
           , 0 /*SUM(MD.D25)*/ AS D25               -- 사용X
           , 0 /*SUM(MD.D26)*/ AS D26               -- 사용X
           , 0 /*SUM(MD.D27)*/ AS D27               -- 사용X
           , 0 /*SUM(MD.D28)*/ AS D28               -- 사용X
           , 0 /*SUM(MD.D29)*/ AS D29               -- 사용X
           , SUM(MP.TOT_DED_AMOUNT) AS TOT_DED_AMOUNT 
           , SUM(MP.NATIONAL_PENSION) AS NATIONAL_PENSION
           , SUM(MP.HEALTH_INSUR) AS HEALTH_INSUR
           , SUM(MP.UNEMPLOYMENT_INSUR) AS UNEMPLOYMENT_INSUR
           , SUM(MP.SAFETY_INSUR) AS SAFETY_INSUR
           , SUM(MP.BENEFIT_AMOUNT) AS BENEFIT_AMOUNT
        ...
        FROM HRT_MONTH_PAYMENT MP
          ...
          , HRM_FLOOR_V HF
          , HRT_MONTH_ALLOWANCE_V MA
          , HRT_MONTH_DEDUCTION_V MD
          , (SELECT MT.PERSON_ID
      ...
      SELECT CASE
        ...
        FROM HRT_MONTH_PAYMENT MP        
          ...
          , (SELECT MT.DUTY_YYYYMM 
                 ...
                 , MT.TOTAL_ATT_DAY      -- 정상근무.
                 , MTD.DUTY_30 AS DUTY_30   -- 공가.
                 , HRT_PAYMENT_G.MONTH_HOLY_COUNT_F(MT.PERSON_ID, MT.DUTY_YYYYMM, W_WAGE_TYPE, '1', MT.SOB_ID, MT.ORG_ID) AS S_HOLY_1_COUNT   -- 주차.
...
-- 월급여 자료 수정.
  ...
  AS
    ...
    V_CORP_ID                     HRT_MONTH_PAYMENT.CORP_ID%TYPE;
    V_PAY_YYYYMM                  HRT_MONTH_PAYMENT.PAY_YYYYMM%TYPE;
    V_WAGE_TYPE                   HRT_MONTH_PAYMENT.WAGE_TYPE%TYPE;
    V_SOB_ID                      HRT_MONTH_PAYMENT.SOB_ID%TYPE;
    V_ORG_ID                      HRT_MONTH_PAYMENT.ORG_ID%TYPE;
  ...
  BEGIN
    ...
    UPDATE HRT_MONTH_PAYMENT
      SET NATIONAL_PENSION    = NVL(P_NATIONAL_PENSION, 0)
        , HEALTH_INSUR        = NVL(P_HEALTH_INSUR, 0)
        , UNEMPLOYMENT_INSUR  = NVL(P_UNEMPLOYMENT_INSUR, 0)
        , SAFETY_INSUR        = NVL(P_SAFETY_INSUR, 0)
        , REAL_AMOUNT         = NVL(TOT_SUPPLY_AMOUNT, 0) - NVL(TOT_DED_AMOUNT, 0) + 
                                NVL(P_NATIONAL_PENSION, 0) + NVL(P_HEALTH_INSUR, 0) + 
                                NVL(P_UNEMPLOYMENT_INSUR, 0) + NVL(P_SAFETY_INSUR, 0) + 
    ...
    OPEN P_CURSOR1 FOR
      SELECT MA.PERSON_ID
       ...
       WHERE MA.ALLOWANCE_ID            = HA.ALLOWANCE_ID
         AND MA.CORP_ID                 = NVL(W_CORP_ID, MA.CORP_ID)
  ...
  BEGIN
    ...
    BEGIN
      SELECT COUNT(MA.ALLOWANCE_ID) AS RECORD_COUNT
        INTO V_RECORD_COUNT
        FROM HRT_MONTH_ALLOWANCE MA
       WHERE MA.CORP_ID                 = NVL(P_CORP_ID, MA.CORP_ID)
    ...
    INSERT INTO HRT_MONTH_ALLOWANCE
    ( PERSON_ID
    , PAY_YYYYMM 
    , WAGE_TYPE 
    , CORP_ID 
...
-- 월급여 지급항목 UPDATE.
  ...
  AS
    ...
    V_PAY_YYYYMM                  HRT_MONTH_PAYMENT.PAY_YYYYMM%TYPE;
    V_WAGE_TYPE                   HRT_MONTH_PAYMENT.WAGE_TYPE%TYPE;
    V_PERSON_ID                   HRT_MONTH_PAYMENT.PERSON_ID%TYPE;
  BEGIN
    BEGIN
...
-- 월급여 지급항목 Delete.
  ...
  AS
    ...
    V_WAGE_TYPE                   HRT_MONTH_PAYMENT.WAGE_TYPE%TYPE;
    V_PERSON_ID                   HRT_MONTH_PAYMENT.PERSON_ID%TYPE;
    V_USER_ID                     HRT_MONTH_PAYMENT.CREATED_BY%TYPE;
  BEGIN
    BEGIN
      SELECT MP.CORP_ID, MP.PAY_YYYYMM, MP.WAGE_TYPE, MP.PERSON_ID, MP.CREATED_BY
        INTO V_CORP_ID, V_PAY_YYYYMM, V_WAGE_TYPE, V_PERSON_ID, V_USER_ID
        FROM HRT_MONTH_PAYMENT MP
       WHERE MP.MONTH_PAYMENT_ID  = W_MONTH_PAYMENT_ID
       ;
    EXCEPTION WHEN OTHERS THEN
    ...
    OPEN P_CURSOR2 FOR
      SELECT MD.PERSON_ID
       ...
       WHERE MD.DEDUCTION_ID            = HD.DEDUCTION_ID
         AND MD.CORP_ID                 = NVL(W_CORP_ID, MD.CORP_ID)
  ...
  BEGIN
    ...
    BEGIN
      SELECT COUNT(MD.DEDUCTION_ID) AS RECORD_COUNT
        INTO V_RECORD_COUNT
        FROM HRT_MONTH_DEDUCTION MD
       WHERE MD.CORP_ID                 = NVL(P_CORP_ID, MD.CORP_ID)
    ...
    INSERT INTO HRT_MONTH_DEDUCTION
    ( PERSON_ID
    , PAY_YYYYMM 
    , WAGE_TYPE 
    , CORP_ID 
...
-- 4대보험 다시 계산.
  ...
  BEGIN
    ...
    UPDATE HRT_MONTH_PAYMENT MP
      SET MP.NATIONAL_PENSION     = 0
        , MP.HEALTH_INSUR         = 0
        , MP.UNEMPLOYMENT_INSUR   = 0
        , MP.SAFETY_INSUR         = 0
    ...
    IF P_WAGE_TYPE IN ('P2', 'P3','P5') THEN
      HRT_MONTH_BONUS_G_SET.UNEMPLOYMENT_INSURANCE
          ( P_CORP_ID           => P_CORP_ID
          , P_PAY_YYYYMM        => P_PAY_YYYYMM
          , P_WAGE_TYPE         => P_WAGE_TYPE
          , P_PAY_TYPE          => NULL
    ...
    ELSE
      HRT_MONTH_PAYMENT_G_SET.INSURANCE_ETC
          ( P_CORP_ID           => P_CORP_ID
          , P_PAY_YYYYMM        => P_PAY_YYYYMM
          , P_WAGE_TYPE         => P_WAGE_TYPE
          , P_PAY_TYPE          => NULL
...
-- 세금 다시 계산.
  ...
  BEGIN
    ...
    BEGIN
      UPDATE HRT_MONTH_DEDUCTION MD
       ...
       WHERE MD.PERSON_ID         = P_PERSON_ID
         AND MD.PAY_YYYYMM        = P_PAY_YYYYMM
         AND MD.WAGE_TYPE         = P_WAGE_TYPE
         AND MD.CORP_ID           = NVL(P_CORP_ID, MD.CORP_ID)
    ...
    IF P_WAGE_TYPE IN ('P2', 'P3','P5') THEN
      /*-- 상여금.
      HRT_MONTH_BONUS_G_SET.TAX_CREATION
          ( P_CORP_ID           => P_CORP_ID
          , P_PAY_YYYYMM        => P_PAY_YYYYMM
          , P_WAGE_TYPE         => P_WAGE_TYPE
          , P_PAY_TYPE          => NULL
    ...
    ELSE
      /*-- 상여 이외.    
      HRT_MONTH_PAYMENT_G_SET.TAX_CREATION
          ( P_CORP_ID           => P_CORP_ID
          , P_PAY_YYYYMM        => P_PAY_YYYYMM
          , P_WAGE_TYPE         => P_WAGE_TYPE
          , P_PAY_TYPE          => NULL
...
-- 지급/공제 합계 처리.
  ...
  BEGIN
      ...
      UPDATE HRT_MONTH_PAYMENT MP
        SET (MP.PAY_AMOUNT, MP.BONUS_AMOUNT, MP.TOT_SUPPLY_AMOUNT, MP.REAL_AMOUNT)
          = ( SELECT NVL(SUM(DECODE(MA.WAGE_TYPE, 'P1', MA.ALLOWANCE_AMOUNT, 0)), 0) AS PAY_AMOUNT
                   , NVL(SUM( CASE
                                WHEN MA.WAGE_TYPE IN('P2', 'P3', 'P5') THEN MA.ALLOWANCE_AMOUNT
                                ELSE 0
      ...
      -- 기업이윤 UPDATE --
      UPDATE HRT_MONTH_PAYMENT MP
        SET MP.BENEFIT_AMOUNT     = HRT_PAYMENT_G_SET.BENEFIT_AMOUNT_F(MP.CORP_ID, MP.TOT_SUPPLY_AMOUNT, MP.SOB_ID, MP.ORG_ID)
          , MP.REAL_AMOUNT        = NVL(MP.REAL_AMOUNT, 0) + HRT_PAYMENT_G_SET.BENEFIT_AMOUNT_F(MP.CORP_ID, MP.TOT_SUPPLY_AMOUNT, MP.SOB_ID, MP.ORG_ID)
      WHERE MP.MONTH_PAYMENT_ID   = P_MONTH_PAYMENT_ID
      ;
      
      -- 공제 항목 합계 UPDATE --
      UPDATE HRT_MONTH_PAYMENT MP
        SET (MP.DED_PAY_AMOUNT, MP.DED_BONUS_AMOUNT, MP.TOT_DED_AMOUNT)
          = ( SELECT NVL(SUM(DECODE(MD.WAGE_TYPE, 'P1', MD.DEDUCTION_AMOUNT, 0)), 0) AS DED_PAY_AMOUNT
                   , NVL(SUM(CASE
                                WHEN MD.WAGE_TYPE IN('P2', 'P3', 'P5') THEN MD.DEDUCTION_AMOUNT
                                ELSE 0
      ...
      -- 지급 합계 UPDATE --
      UPDATE HRT_MONTH_PAYMENT MP
        SET MP.REAL_AMOUNT =  NVL(MP.TOT_SUPPLY_AMOUNT, 0) + 
                              NVL(MP.NATIONAL_PENSION, 0) + NVL(MP.HEALTH_INSUR, 0) +
                              NVL(MP.UNEMPLOYMENT_INSUR, 0) + NVL(MP.SAFETY_INSUR, 0) + 
                              NVL(MP.BENEFIT_AMOUNT, 0) - NVL(MP.TOT_DED_AMOUNT, 0)
      WHERE MP.MONTH_PAYMENT_ID   = P_MONTH_PAYMENT_ID
      ;
