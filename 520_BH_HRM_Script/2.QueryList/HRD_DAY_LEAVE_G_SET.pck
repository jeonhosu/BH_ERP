    ...
    V_RECORD_COUNT := 0;
	    ...
	    -- 자료수 조회.
			...
			WHERE DL.PERSON_ID                            = WC.PERSON_ID
				...
				AND WC.WORK_TYPE_ID                         = NVL(P_WORK_TYPE_ID, WC.WORK_TYPE_ID)
				AND WC.HOLY_TYPE                            = NVL(P_HOLY_TYPE, WC.HOLY_TYPE)
...
-- 주간근무.
          ...
          -- 연장 신청 적용한 종료 시간.
					V_OT_END_TIME := OT_END_TIME_F( P_CLOSE_TIME => V_OT_END_TIME
																				...
																				, P_DEFAULT_RETURN_TIME => C1.END_TIME);
/*DBMS_OUTPUT.PUT_LINE('OT_START =>' || TO_CHAR(V_OT_START_TIME, 'YYYY-MM-DD HH24:MI:SS') || 
...
/*DBMS_OUTPUT.PUT_LINE('3-야할 : OPEN =>' || TO_CHAR(V_OPEN_TIME, 'YYYY-MM-DD HH24:MI:SS') || 
...
-- 휴일근무.
        ...
        -- 4. 휴일근로 계산.
          ...
          V_OT_END_TIME := OT_END_TIME_F( P_CLOSE_TIME => V_OT_END_TIME
                                        ...
                                        , P_DEFAULT_RETURN_TIME => C1.END_TIME);
/*                                        
DBMS_OUTPUT.PUT_LINE('휴일 주간 : OT_START =>' || TO_CHAR(V_OT_START_TIME, 'YYYY-MM-DD HH24:MI:SS') || 
                     ', OT_END=>' || TO_CHAR(V_OT_END_TIME, 'YYYY-MM-DD HH24:MI:SS') || 
										 ', C1_START =>' || TO_CHAR(C1.START_TIME, 'YYYY-MM-DD HH24:MI:SS') || 
                     ', C1_END=>' || TO_CHAR(C1.END_TIME, 'YYYY-MM-DD HH24:MI:SS') ||
										 ', XX =>' || TO_CHAR(V_STD_TIME, 'YYYY-MM-DD HH24:MI:SS'));
        ...
        -- 4-1. 근무후 연장 계산.
          ...
          -- 연장 신청 적용한 종료 시간.
					V_OT_END_TIME := OT_END_TIME_F( P_CLOSE_TIME => V_OT_END_TIME
																				, P_PL_END_TIME => C1.END_TIME
																				, P_DEFAULT_RETURN_TIME => C1.END_TIME);
/*DBMS_OUTPUT.PUT_LINE('휴일 근무후 : OT_START =>' || TO_CHAR(V_OT_START_TIME, 'YYYY-MM-DD HH24:MI:SS') || 
                     ', OT_END=>' || TO_CHAR(V_OT_END_TIME, 'YYYY-MM-DD HH24:MI:SS') || 
										 ', C1_START =>' || TO_CHAR(C1.START_TIME, 'YYYY-MM-DD HH24:MI:SS') || 
                     ', C1_END=>' || TO_CHAR(C1.END_TIME, 'YYYY-MM-DD HH24:MI:SS') ||
...
/*DBMS_OUTPUT.PUT_LINE('휴일 야간 : OT_START =>' || TO_CHAR(V_OT_START_TIME, 'YYYY-MM-DD HH24:MI:SS') || 
                     ', OT_END=>' || TO_CHAR(V_OT_END_TIME, 'YYYY-MM-DD HH24:MI:SS') || 
										 ', C1_START =>' || TO_CHAR(C1.START_TIME, 'YYYY-MM-DD HH24:MI:SS') || 
                     ', C1_END=>' || TO_CHAR(C1.END_TIME, 'YYYY-MM-DD HH24:MI:SS') ||
										 ', XX =>' || TO_CHAR(V_STD_TIME, 'YYYY-MM-DD HH24:MI:SS'));*/
          ...
          -- 야간 할증 범위 적용.
					V_OT_END_TIME := OT_END_TIME_F( P_CLOSE_TIME => V_OT_END_TIME
																				, P_PL_END_TIME => C1.END_TIME
																				, P_DEFAULT_RETURN_TIME => C1.END_TIME);
/*DBMS_OUTPUT.PUT_LINE('휴일 야할 : OT_START =>' || TO_CHAR(V_OT_START_TIME, 'YYYY-MM-DD HH24:MI:SS') || 
                     ', OT_END=>' || TO_CHAR(V_OT_END_TIME, 'YYYY-MM-DD HH24:MI:SS') || 
										 ', C1_START =>' || TO_CHAR(C1.START_TIME, 'YYYY-MM-DD HH24:MI:SS') || 
                     ', C1_END=>' || TO_CHAR(C1.END_TIME, 'YYYY-MM-DD HH24:MI:SS') ||
										 ', XX =>' || TO_CHAR(V_STD_TIME, 'YYYY-MM-DD HH24:MI:SS'));																				*/
...
\*DBMS_OUTPUT.PUT_LINE('OT_START =>' || TO_CHAR(V_OT_START_TIME, 'YYYY-MM-DD HH24:MI:SS') ||
          ...
          IF V_OT_START_TIME <= V_STD_TIME THEN
					  ...
					  -- 근무전 연장 계산.
						BEGIN
						  V_B_OVER_TIME := ROUND((V_OT_END_TIME - V_OT_START_TIME) * 24, 2) - V_FOOD_DED_TIME;
						EXCEPTION WHEN OTHERS THEN
						  V_B_OVER_TIME := 0;
						END;
					END IF;
...
\*DBMS_OUTPUT.PUT_LINE('OT_START =>' || TO_CHAR(V_OT_START_TIME, 'YYYY-MM-DD HH24:MI:SS') ||
          ...
          IF V_STD_TIME <= V_OT_END_TIME THEN
					  ...
					  -- 근무후 연장 계산.
						BEGIN
						  V_A_OVER_TIME := ROUND((V_OT_END_TIME - V_OT_START_TIME) * 24, 2) - V_FOOD_DED_TIME;
						EXCEPTION WHEN OTHERS THEN
						  V_A_OVER_TIME := 0;
						END;
					END IF;
...
\*DBMS_OUTPUT.PUT_LINE('OT_START =>' || TO_CHAR(V_OT_START_TIME, 'YYYY-MM-DD HH24:MI:SS') ||
          ...
          IF V_STD_TIME <= V_OT_END_TIME THEN
					  ...
					  -- 야간근로 연장 계산.
						BEGIN
						  V_NIGHT_TIME := ROUND((V_OT_END_TIME - V_OT_START_TIME) * 24, 2) - V_FOOD_DED_TIME;
						EXCEPTION WHEN OTHERS THEN
						  V_NIGHT_TIME := 0;
						END;
					END IF;
...
\*DBMS_OUTPUT.PUT_LINE('OT_START =>' || TO_CHAR(V_OT_START_TIME, 'YYYY-MM-DD HH24:MI:SS') ||
          ...
          IF V_STD_TIME <= V_OT_END_TIME THEN
					  ...
					  -- 야간할증 계산.
						BEGIN
						  V_NIGHT_BONUS_TIME := ROUND((V_OT_END_TIME - V_OT_START_TIME) * 24, 2)\* - V_FOOD_DED_TIME*\;
						EXCEPTION WHEN OTHERS THEN
						  V_NIGHT_BONUS_TIME := 0;
						END;
					END IF;
...
\*DBMS_OUTPUT.PUT_LINE('휴일 주간 : OT_START =>' || TO_CHAR(V_OT_START_TIME, 'YYYY-MM-DD HH24:MI:SS') ||
          ...
          IF V_STD_TIME <= V_OT_END_TIME THEN
              ...
              V_FOOD_DED_TIME := NVL(V_FOOD_DED_TIME, 0) +
					  ...
					  -- 휴일근로 계산.
						BEGIN
						  V_HOLIDAY_TIME := ROUND((V_OT_END_TIME - V_OT_START_TIME) * 24, 2) - V_FOOD_DED_TIME;
						EXCEPTION WHEN OTHERS THEN
						  V_HOLIDAY_TIME := 0;
						END;
					END IF;
        ...
        -- 4-1. 근무후 연장 계산.
				IF C1.HOLIDAY_YN = 'Y' \*C1.OT_YN = 'Y'*\ AND C1.CAL_TYPE = 'OA' AND C1.HOLY_TYPE = 'DAY'
					AND V_CLOSE_TIME IS NOT NULL AND W_AFTER_OT_START IS NOT NULL AND W_AFTER_OT_END IS NOT NULL THEN
				  -- 연장 신청 적용한 시작 시간.
					V_OT_START_TIME := OT_START_TIME_F( P_OPEN_TIME => V_OPEN_TIME
					                                  , P_PL_START_TIME => W_AFTER_OT_START
...
-- DAY INTERFACE --> DAY LEAVE UPDATE.
  ...
  AS
    ...
    BEGIN
      ...
      WHERE DI.PERSON_ID				                  = NVL(W_PERSON_ID, DI.PERSON_ID)
