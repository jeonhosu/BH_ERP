...
COMMENT ON COLUMN HRP_PAY_MASTER_LINE.PAY_LINE_ID IS '급여마스터 LINE ID';
COMMENT ON COLUMN HRP_PAY_MASTER_LINE.PAY_HEADER_ID IS '급여마스터 헤더 ID';
COMMENT ON COLUMN HRP_PAY_MASTER_LINE.ALLOWANCE_TYPE IS '지급공제 구분(A-지급, D-공제)';
COMMENT ON COLUMN HRP_PAY_MASTER_LINE.ALLOWANCE_ID IS '수당 ID';
COMMENT ON COLUMN HRP_PAY_MASTER_LINE.ALLOWANCE_AMOUNT IS '수당 금액';
COMMENT ON COLUMN HRP_PAY_MASTER_LINE.DESCRIPTION IS '비고';
COMMENT ON COLUMN HRP_PAY_MASTER_LINE.CREATION_DATE  IS '생성일자';
COMMENT ON COLUMN HRP_PAY_MASTER_LINE.CREATED_BY IS '생성자';
COMMENT ON COLUMN HRP_PAY_MASTER_LINE.LAST_UPDATE_DATE IS '최종수정일자';
COMMENT ON COLUMN HRP_PAY_MASTER_LINE.LAST_UPDATED_BY IS '최종수정자';
