...
(person_id, work_date, work_corp_id, corp_id, dept_id, post_id, job_category_id, work_type_id, duty_id, source_duty_id, holy_type, open_time, close_time, open_time1, close_time1, next_day_yn, leave_id, leave_time_code, modify_yn, modify_in_yn, modify_out_yn, modify_flag, approved_yn, approved_date, approved_person_id, confirmed_yn, confirmed_date, confirmed_person_id, approve_status, trans_yn, trans_date, trans_person_id, description, sob_id, org_id, created_by, last_update_date, last_updated_by, plan_open_time, plan_close_time, before_ot_start, before_ot_end, after_ot_start, after_ot_end, breakfast_yn, lunch_yn, dinner_yn, midnight_yn, dangjik_yn, all_night_yn, work_type_group, person_check_yn, person_check_date, person_check_by, reject_remark, reject_yn, reject_date, reject_person_id, t_duty_id, t_duty_desc, work_holy_type)
AS
SELECT                      /*+ INDEX(HRD_DAY_INTERFACE HRD_DAY_INTERFACE_U1) */
            di.person_id,
             ...
             di.post_id,
             di.job_category_id,
             NVL (wc.work_type_id, di.work_type_id) AS work_type_id,
             NVL (wc.c_duty_id1, NVL (wc.c_duty_id, di.duty_id)) duty_id,
             di.duty_id as source_duty_id,
             ...
             di.leave_id,
             di.leave_time_code,
             nvl(di.modify_yn, 'N') modify_yn,
             nvl(di.modify_in_yn, 'N') modify_in_yn,
             nvl(di.modify_out_yn, 'N') modify_out_yn,
             CASE
             ...
             T_DUTY_ID,
             T_DUTY_DESC,
             nvl(wc.attribute3, '2') as work_holy_type
