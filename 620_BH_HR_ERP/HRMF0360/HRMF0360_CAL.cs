...
namespace HRMF0360
{
    public partial class HRMF0360_CAL : Office2007Form
    {
        #region ----- Variables -----
        ...
        public HRMF0360_CAL(ISAppInterface pAppInterface, object pSTART_DATE, object pEND_DATE, 
        ...
        private void HRMF0360_CAL_Load(object sender, EventArgs e)
        {
             
        }

        private void HRMF0360_CAL_Shown(object sender, EventArgs e)
        {
        ...
        private void itb_CAL_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            mStatus = iString.ISNull(IDC_SET_OT.GetCommandParamValue("O_STATUS"));
