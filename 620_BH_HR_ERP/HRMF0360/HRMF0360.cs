...
namespace HRMF0360
{
    public partial class HRMF0360 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public HRMF0360(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void HRMF0360_Load(object sender, EventArgs e)
        {
        }

        private void HRMF0360_Shown(object sender, EventArgs e)
        {
            DefaultValues();
        ...
        private void isButton1_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            HRMF0360_CAL vHRMF0634_CAL = new HRMF0360_CAL(isAppInterfaceAdv1.AppInterface
