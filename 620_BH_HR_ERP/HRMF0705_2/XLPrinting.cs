...
namespace HRMF0705
{
    public class XLPrinting
    {
        ...
        private int mIncrementCopyMAX_1 = 184;  // 1page : 61, 2page : 122, 3page : 183 - 복사되어질 행의 범위
        private int mIncrementCopyMAX_2 = 61;   // 5page
        private int mIncrementCopyMAX_3 = 61;   // 5page
        ...
        {
            pGDColumn = new int[141];
            pXLColumn = new int[141];
        ...
        private int XLLine13(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid_WITHHOLDING_TAX, int pGridRow, int pXLine, int[] pGDColumn, int[] pXLColumn, object vPrintDate, object vPrintType)
        {
        ...
        #region ----- 거주자간 주택임차차입금 원리금 상환액 소득공제 명세-----
                            ...
                            , InfoSummit.Win.ControlAdv.ISDataAdapter pidaHOUSE_LEASE_INFO_20)
        {
            ...
            for (int vRow1 = 0; vRow1 < vTotalRow1 || vRow1 < vTotalRow3; vRow1++)
            {
                ...
                if (isOpen == true)
                {
                    ...
                    if (pPrint_Year == "2011")
                    {
                        vPrintingLine = XLLine11(pGrid_WITHHOLDING_TAX, vRow1, vPrintingLine, vGDColumn_1, vXLColumn_1, vPrintDate, vPrintType);
                    }
                    else if (pPrint_Year == "2012")
                    {
                        vPrintingLine = XLLine12(pGrid_WITHHOLDING_TAX, vRow1, vPrintingLine, vGDColumn_1, vXLColumn_1, vPrintDate, vPrintType);
                    }
                    else
                    {
                        vPrintingLine = XLLine13(pGrid_WITHHOLDING_TAX_13, vRow1, vPrintingLine, vGDColumn_5, vXLColumn_5, vPrintDate, vPrintType);
                    }
                    //---------------------------------------------------------------------------------------------------------------------
        ...
        private int CopyAndPaste_1(int pCopySumPrintingLine)
        {
            ...
            int vCopyPrintingRowEnd = mIncrementCopyMAX_1 - 1;
