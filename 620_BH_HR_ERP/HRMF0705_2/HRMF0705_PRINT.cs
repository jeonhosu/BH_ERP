...
namespace HRMF0705
{
    public partial class HRMF0705_PRINT : Office2007Form
    {
        ...
        //HRMF0705_001.xls
        private void XLPrinting1(string pPrint_Year)
        {
            ...
            try
            {
                ...
                {
                    vPrintType = "소득자 보관용";
                    vPageNumber = xlPrinting.WriteMain(gridWITHHOLDING_TAX, gridWITHHOLDING_TAX_13, gridSUPPORT_FAMILY, IGR_SAVING_INFO_2, IGR_SAVING_INFO_3, IGR_SAVING_INFO_4, IGR_SAVING_INFO_5, vPrintDate, vPrintType, mOutChoice, vPageNumber, vPRINT_SAVING_YN, vPrint_Year, vPRINT_HOUSE_YN, idaHOUSE_LEASE_INFO_10, idaHOUSE_LEASE_INFO_20);
                }
        ...
        private void btnPRINT_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            else if (Convert.ToInt32(iedCERT_TYPE_CODE.EditValue) == 22) // 근로소득영수증
            {
                ...
                string vPrint_Year = iString.ISNull(iedPRINT_YEAR.EditValue);
                XLPrinting1(vPrint_Year); // 출력 함수 호출
