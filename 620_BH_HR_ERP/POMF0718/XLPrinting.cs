...
namespace POMF0718
{
    public class XLPrinting
    {
        ...
        public void HeaderWrite(InfoSummit.Win.ControlAdv.ISDataAdapter pData)
        {
            object vObject = null;
            try
            {
                ...
                int vIndexColumn_01 = pData.OraSelectData.Columns.IndexOf("GL_NUM");          //전표번호[GL_NUM]
                //int vIndexColumn_02 = pGrid.GetColumnToIndex("SLIP_DATE");       //작성일자[SLIP_DATE]
                int vIndexColumn_02 = pData.OraSelectData.Columns.IndexOf("SLIP_DATE");       //작성일자[SLIP_DATE]
                //int vIndexColumn_03 = pGrid.GetColumnToIndex("DEPT_NAME");       //작성부서[DEPT_NAME]
                int vIndexColumn_03 = pData.OraSelectData.Columns.IndexOf("DEPT_NAME");       //작성부서[DEPT_NAME]
                //int vIndexColumn_04 = pGrid.GetColumnToIndex("PERSON_NAME");     //작성자[PERSON_NAME]
                int vIndexColumn_04 = pData.OraSelectData.Columns.IndexOf("PERSON_NAME");     //작성자[PERSON_NAME]
                ...
                int vIndexColumn_07 = pData.OraSelectData.Columns.IndexOf("SLIP_NUM");        //기표번호[SLIP_NUM]
                ...
                //전표번호[GL_NUM]
                vObject = pData.OraSelectData.Rows[0][vIndexColumn_01];
                if (vObject != null)
                {
                ...
                vObject = pData.OraSelectData.Rows[0][vIndexColumn_02];
                if (vObject != null)
                {
                ...
                vObject = pData.OraSelectData.Rows[0][vIndexColumn_03];
                if (vObject != null)
                {
                ...
                vObject = pData.OraSelectData.Rows[0][vIndexColumn_04];
                if (vObject != null)
                {
                ...
                vObject = pData.OraSelectData.Rows[0][vIndexColumn_07];
                if (vObject != null)
                {
        ...
        public int LineWrite(InfoSummit.Win.ControlAdv.ISDataAdapter pData, System.Data.DataTable pTable_DOC_APPROVAL_LINE)
        {
            ...
            try
            {
                ...
                foreach (System.Data.DataRow vRow in pData.OraSelectData.Rows)
                {
                    ...
                    vMessage = string.Format("Writing : {0}/{1}", vCountRow, vTotalRow);
