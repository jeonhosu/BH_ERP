...
namespace HRMF0507
{
    public class XLPrinting
    {
        ...
        private int XlLine(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, int pRow, int pPrintingLine, string[] pGridColumn, int[] pXLColumn)
        {
            ...
            IsNewPage(pPrintingLine, IsPageSkep);
            if (mIsNewPage == true)
            {
            ...
            try
            {
                ...
                if (vTotalRow > 0)
                {
                    ...
                    for (int vRow = 0; vRow < vTotalRow; vRow++)
                    {
                        ...
                        vMessage = string.Format("Row : {0} / {1}", vCountRow, vTotalRow);
                        ...
                        if (vTotalRow == vCountRow)
                        {
                            ...
                            {
                                mCopySumPrintingLine = CopyAndPaste(mCopySumPrintingLine, vPrintingLine);
                            }
        ...
        private void IsNewPage(int pPrintingLine, bool pIsPageSkep)
        {
            if (mPrintingLineMAX < pPrintingLine)
            {
                mIsNewPage = true;
                mCopySumPrintingLine = CopyAndPaste(mCopySumPrintingLine, pPrintingLine);
        ...
        private int CopyAndPaste(int pCopySumPrintingLine, int pPrintingLine)
        {
