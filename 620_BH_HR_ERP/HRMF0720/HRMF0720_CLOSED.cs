...
namespace HRMF0720
{
    public partial class HRMF0720_CLOSED : Office2007Form
    {
        #region ----- Variables -----
        ...
        public HRMF0720_CLOSED()
        {
            InitializeComponent();
        }

        public HRMF0720_CLOSED(Form pMainForm, ISAppInterface pAppInterface
                                , object pSTD_YYYYMM
        ...
        private void HRMF0720_CLOSED_Load(object sender, EventArgs e)
        {
            
        }

        private void HRMF0720_CLOSED_Shown(object sender, EventArgs e)
        {
