...
namespace HRMF0720
{
    public partial class HRMF0720 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public HRMF0720(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void HRMF0720_Load(object sender, EventArgs e)
        {

        }

        private void HRMF0720_Shown(object sender, EventArgs e)
        {
            // Lookup SETTING
        ...
        private void BTN_CLOSED_OK_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            HRMF0720_CLOSED vHRMF0720_CLOSED = new HRMF0720_CLOSED(this.MdiParent, isAppInterfaceAdv1.AppInterface
            ...
            vHRMF0720_CLOSED.ShowDialog();
            vHRMF0720_CLOSED.Dispose();
        }
