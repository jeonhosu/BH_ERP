    ...
    public partial class HRMF0519 : Office2007Form
    {
        ...
        private void XLPrinting1(string CoursePrint)
        {
            ...
            try
            {
                ...
                {
                    xlPrinting.OpenFileNameExcel = "HRMF0519_001.xlsx";
                }
                ...
                if (IsOpen == true)
                {
                    ...
                    vPageNumber = xlPrinting.XLWirte(igrMONTH_PAYMENT, vTerritory, vUserName, vCORP_NAME, vYYYYMM_FROM, vYYYYMM_TO, vWageTypeName, vDepartment_NAME);
