...
namespace HRMF0508
{
    public class XLPrinting
    {
        ...
        private int mIncrementCopyMAX = 44;  //복사되어질 행의 범위
        ...
        private void SetArray1(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, out int[] pGDColumn, out int[] pXLColumn)
        {
            ...
            pGDColumn[0] = pGrid.GetColumnToIndex("NAME");
            pGDColumn[1] = pGrid.GetColumnToIndex("PERSON_NUM");
            pGDColumn[2] = pGrid.GetColumnToIndex("DEPT_NAME");
            pGDColumn[3] = pGrid.GetColumnToIndex("PAY_GRADE_NAME");
            pGDColumn[4] = pGrid.GetColumnToIndex("BANK_NAME");
            pGDColumn[5] = pGrid.GetColumnToIndex("BANK_ACCOUNTS");
            pGDColumn[6] = pGrid.GetColumnToIndex("REAL_AMOUNT");
        ...
        private void XLHeader(string pPrintingDate, string pPrintingTime, string pLoginUser, string pAssembly)
        {
            int vXLine = 0;
            int vXLColumn = 0;
        ...
        public int LineWrite(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, string pLoginUser, string pAssembly)
        {
            mPageNumber = 0;
            ...
            try
            {
                ...
                XLHeader(vPrintingDate, vPrintingTime, pLoginUser, pAssembly);
        ...
        {
            int vPrintingLineEND = mCopyLineSUM - 2; //1~44: mCopyLineSUM=45에서 내용이 출력되는 행이 43 이므로, 2을 빼면 된다
        ...
        private int CopyAndPaste(int pCopySumPrintingLine)
        {
            ...
            mPrinting.XLSetCell(vRow, 41, vPageString);
