...
namespace HRMF0786
{
    public partial class HRMF0786 : Office2007Form
    {
        ...
        private void XLPrinting1(string pOutput_Type)
        {
            ...
            {
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "HRMF0786_001.xls";
                //-------------------------------------------------------------------------------------
                ...
                if (isOpen == true)
                {
                    ...
                    vPageNumber = xlPrinting.ExcelWrite(IDA_PRINT_OFFICE_TAX_DOC);
        ...
        private void XLPrinting2(string pOutput_Type)
        {
            ...
            {
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "HRMF0786_002.xls";
                //-------------------------------------------------------------------------------------
            ...
            if (this.IsActive)
            {
                ...
                {  
                    if (IDA_OFFICE_TAX_LIST.IsFocused || IDA_OFFICE_TAX_DOC.IsFocused)
                    {
                        ...
                        OWNER_TAX_FREE_YN.CheckBoxValue = "Y";
                        Set_Pay_Supply_Date();
                        OFFICE_TAX_TYPE_DESC.Focus();
                    }
                }
                ...
                else if (e.AppMainButtonType == ISUtil.Enum.AppMainButtonType.Delete)
                {
                    if (IDA_OFFICE_TAX_LIST.IsFocused)
                    {
                        IDA_OFFICE_TAX_LIST.Delete();
                    }
                    else if (IDA_OFFICE_TAX_DOC.IsFocused)
                    {
                        IDA_OFFICE_TAX_DOC.Delete();
                    }
                }
