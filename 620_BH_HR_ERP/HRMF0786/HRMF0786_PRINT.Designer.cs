namespace HRMF0786
{
    partial class HRMF0786_PRINT
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.CB_PRINT_1.PromptText = "지방소득세(종업원분) 신고서";
            isLanguageElement2.Default = "지방소득세(종업원분) 신고서";
            isLanguageElement2.SiteName = null;
            isLanguageElement2.TL1_KR = "지방소득세(종업원분) 신고서";
            ...
            this.CB_PRINT_2.PromptText = "지방소득세(종업원분) 납부서";
            isLanguageElement3.Default = "지방소득세(종업원분) 납부서";
            isLanguageElement3.SiteName = null;
            isLanguageElement3.TL1_KR = "지방소득세(종업원분) 납부서";
