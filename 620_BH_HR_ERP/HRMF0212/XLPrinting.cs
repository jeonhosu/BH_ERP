...
namespace HRMF0212
{
    public class XLPrinting
    {
        ...
        private int mCopy_EndCol = 69;
        private int mCopy_EndRow = 29;
        private int mPrintingLastRow = 28;  //실제 데이터 인쇄 최종 라인.
        ...
        {// 그리드의 컬럼에 대한 컬럼인덱스 값 산출
            ...
            pGDColumn[7] = pGrid.GetColumnToIndex("PAY_GRADE_NAME");
            ...
            pGDColumn[11] = pGrid.GetColumnToIndex("CONTINUE_YEAR");
            pGDColumn[12] = pGrid.GetColumnToIndex("END_SCH_NAME");
