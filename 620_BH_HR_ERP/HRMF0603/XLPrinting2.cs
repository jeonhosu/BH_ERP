...
namespace HRMF0603
{
    public class XLPrinting2
    {
        ...
        {
            pGDColumn = new int[134];
            pXLColumn = new int[134];
            ...
            //이연퇴직소득세액계산
            pGDColumn[99] = pGrid_PRINT_2013.GetColumnToIndex("REPORT_TAX_SUM39");                         // 신고대상세액 (39)                                  
            ...
            pGDColumn[104] = pGrid_PRINT_2013.GetColumnToIndex("DEPOSIT_AMOUNT");                          // 계좌입금금액                                    
            pGDColumn[105] = pGrid_PRINT_2013.GetColumnToIndex("RETIREMENT_PAY");                          // 퇴직급여                                
            pGDColumn[106] = pGrid_PRINT_2013.GetColumnToIndex("DEFERRED_TAX");                            // 이연퇴직소득세        
            ...
            pGDColumn[121] = pGrid_PRINT_2013.GetColumnToIndex("FINAL_RETIRE_DATE");                             // 정산지급일     
            ...
            pXLColumn[75] = 14;    // 퇴직소득(중간지급)                                            
            pXLColumn[76] = 24;   // 퇴직소득(최종분)                                             
            pXLColumn[77] = 34;   // 퇴직소득(정산(합산)  

            pXLColumn[78] = 34;   // 퇴직소득정률공제   

            pXLColumn[79] = 34;   // 근속연수공제      

            pXLColumn[80] = 34;   // 퇴직소득과세표준(27-28-29)    


            //-----------------------------------------
            pXLColumn[81] = 14;   // 과세표준안분(2012.12.31이전)                                       
            pXLColumn[82] = 14;   // 연평균과세표준(2012.12.31이전)                                   
            pXLColumn[83] = 14;   // 연평균산출세액(2012.12.31이전) 
            pXLColumn[84] = 14;   // 산출세액 (2012.12.31이전)

            pXLColumn[85] = 24;   // 과세표준안분(2013.01.01이후 )                                               
            pXLColumn[86] = 24;   // 과세표준(2013.01.01이후 )                                     
            pXLColumn[87] = 24;   // 환산과세표준 (2013.01.01이후 )                                          
            pXLColumn[88] = 24;   // 환산산출세액 (2013.01.01이후 )  
            pXLColumn[89] = 24;   // 연평균산출세액 (2013.01.01이후 )            
            pXLColumn[90] = 24;   // 산출세액 (2013.01.01이후 )


            pXLColumn[91] = 34;   // 과세표준안분(정산(합산))                                             
            pXLColumn[92] = 34;   // 연평균과세표준(정산(합산))
            pXLColumn[93] = 34;   // 환산과세표준                             
            pXLColumn[94] = 34;   // 환산산출세액액                                        
            pXLColumn[95] = 34;   // 연평균산출세액                            
            pXLColumn[96] = 34;   // 산출세액 
            pXLColumn[97] = 34;   // 기납부세액             
            pXLColumn[98] = 34;   // 신고대상세액 


            //-----------------------------------------
            pXLColumn[99] = 3;    // 신고대상세액 (39) 
            pXLColumn[100] = 9;   // 연금계좌취급자
            ...
            pXLColumn[122] = 39;   // 31.퇴직소득(정산(합산))
            pXLColumn[123] = 39;   // 32.근속연수공제
            pXLColumn[124] = 39;   // 33.환산급여
            pXLColumn[125] = 39;   // 34.환산급여별공제
            pXLColumn[126] = 39;   // 35.퇴직소득과세표준
            pXLColumn[127] = 39;   // 42.환산산출세액
            pXLColumn[128] = 39;   // 43.산출세액
            pXLColumn[129] = 39;   // 44.퇴직일이 속하는 과세연도
            pXLColumn[130] = 39;   // 45.특례적용산출세액
            pXLColumn[131] = 39;   // 46.기납부 세액
            pXLColumn[132] = 39;   // 47.신고대상세액
        }
        ...
        private int XLLine2(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid_PRINT_2013, int pGridRow, int pXLine, int[] pGDColumn, int[] pXLColumn, object pPrintType, string pCourse)
        {
            int vXLine = pXLine; // 엑셀에 내용이 표시되는 행 번호
        ...
        private int XLLine_2016(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid_PRINT_2013, int pGridRow, int pXLine, int[] pGDColumn, int[] pXLColumn, object pPrintType, string pCourse)
        {
            int vXLine = pXLine; // 엑셀에 내용이 표시되는 행 번호
            ...
            try
            {
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(vXLine, vXLColumnIndex - 10, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(vXLine + 1, vXLColumnIndex - 5, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(vXLine + 1, vXLColumnIndex - 10, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(vXLine + 2, vXLColumnIndex - 5, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(vXLine + 2, vXLColumnIndex - 10, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(vXLine + 3, vXLColumnIndex - 5, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(vXLine + 3, vXLColumnIndex - 10, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                //{
                //    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                //    mPrinting.XLSetCell(vXLine + 2, vXLColumnIndex + 25, vConvertString);
                //}
                //else
                //{
                //    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(31, vXLColumnIndex, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(32, vXLColumnIndex, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(33, vXLColumnIndex, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(34, vXLColumnIndex, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(35, vXLColumnIndex, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(37, vXLColumnIndex, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(38, vXLColumnIndex, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0}", vConvertDecimal);
                    mPrinting.XLSetCell(40, vXLColumnIndex, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(41, vXLColumnIndex, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(44, vXLColumnIndex, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
                ...
                {
                    vConvertString = string.Format("{0:#,###,###,###,###,###}", vConvertDecimal);
                    mPrinting.XLSetCell(45, vXLColumnIndex, vConvertString);
                }
                else
                {
                    vConvertString = string.Empty;
        ...
        public int WriteWithholdingTax(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid_WITHHOLDING_TAX, InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid_PRINT_2013, object pPrintType, string pOutChoice)
        {
            ...
            else if (vRetire_Year == "2013" || vRetire_Year == "2014" || vRetire_Year == "2015")
            {
                ...
                for (int vRow = 0; vRow < vTotalRow; vRow++)
                {
                    ...
                    if (isOpen == true)
                    {
                        ...
                        // 퇴직소득원천징수영수증/지급조서
                        vPrintingLine = XLLine2(pGrid_PRINT_2013, vRow, vPrintingLine, vGDColumn, vXLColumn, pPrintType, "SRC_TAB1");
            ...
            else
            {
                ...
                for (int vRow = 0; vRow < vTotalRow; vRow++)
                {
                    ...
                    if (isOpen == true)
                    {
                        ...
                        // 퇴직소득원천징수영수증/지급조서
                        vPrintingLine = XLLine_2016(pGrid_PRINT_2013, vRow, vPrintingLine, vGDColumn, vXLColumn, pPrintType, "SRC_TAB1");
