    ...
    public partial class HRMF0224 : Office2007Form
    {
        ...
        private void isAppInterfaceAdv1_AppMainButtonClick(ISAppButtonEvents e)
        {
            if (this.IsActive)
            {
                ...
                {
                    if (IDA_SCHOLARSHIP_STATE_1.IsFocused)
                    {
                        IDA_SCHOLARSHIP_STATE_1.AddOver();
                    }
                }
                else if (e.AppMainButtonType == ISUtil.Enum.AppMainButtonType.AddUnder)
                {
                    if (IDA_SCHOLARSHIP_STATE_1.IsFocused)
                    {
                        IDA_SCHOLARSHIP_STATE_1.AddUnder();
                    }
                }
                else if (e.AppMainButtonType == ISUtil.Enum.AppMainButtonType.Update)
                {
                    if (IDA_SCHOLARSHIP_STATE_1.IsFocused)
                    {
                        IDA_SCHOLARSHIP_STATE_1.Update();
                    }
                }
                else if (e.AppMainButtonType == ISUtil.Enum.AppMainButtonType.Cancel)
                {
                    if (IDA_SCHOLARSHIP_STATE_1.IsFocused)
                    {
                        IDA_SCHOLARSHIP_STATE_1.Cancel();
                    }
                }
                else if (e.AppMainButtonType == ISUtil.Enum.AppMainButtonType.Delete)
                {
                    if (IDA_SCHOLARSHIP_STATE_1.IsFocused)
                    {
                        IDA_SCHOLARSHIP_STATE_1.Delete();
                    }
                }
            }
        }
