...
namespace HRMF0781
{
    public partial class HRMF0781 : Office2007Form
    {
        ...
        private void XLPrinting2(string pOutput_Type)
        {
            ...
            {
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "HRMF0781_002.xls";
                //-------------------------------------------------------------------------------------
        ...
        private void XLPrinting3(string pOutput_Type)
        {
            ...
            {
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "HRMF0781_003.xls";
                //-------------------------------------------------------------------------------------
        ...
        private void XLPrinting4(string pOutput_Type)
        {
            ...
            {
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "HRMF0781_004.xls";
                //-------------------------------------------------------------------------------------
        ...
        private void CAL_A10_THIS_REFUND_TAX_AMT()
        {
            ...
            else if (iConv.ISDecimaltoZero(A10_PAY_INCOME_TAX_AMT.EditValue) > NEXT_REFUND_TAX_AMT_F())
            {
            ...
            {
                A10_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A10_PAY_INCOME_TAX_AMT.EditValue);
                A10_PAY_INCOME_TAX_AMT.EditValue = 0;
            }
            //농특세
            if (NEXT_REFUND_TAX_AMT_F() <= 0)
            ...
            else if (iConv.ISDecimaltoZero(A10_PAY_SP_TAX_AMT.EditValue) > NEXT_REFUND_TAX_AMT_F())
            {
                A10_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A10_THIS_REFUND_TAX_AMT.EditValue) +
                                                    NEXT_REFUND_TAX_AMT_F();
                A10_PAY_SP_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A10_PAY_SP_TAX_AMT.EditValue) -
                                                iConv.ISDecimaltoZero(A10_THIS_REFUND_TAX_AMT.EditValue);
            }
            else if (iConv.ISDecimaltoZero(A10_PAY_SP_TAX_AMT.EditValue) < NEXT_REFUND_TAX_AMT_F())
            {
                A10_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A10_THIS_REFUND_TAX_AMT.EditValue) +
                                                    iConv.ISDecimaltoZero(A10_PAY_SP_TAX_AMT.EditValue);
                A10_PAY_SP_TAX_AMT.EditValue = 0;
            }
        ...
        private void CAL_A20_THIS_REFUND_TAX_AMT()
        {
            ...
            else if (iConv.ISDecimaltoZero(A20_PAY_INCOME_TAX_AMT.EditValue) > NEXT_REFUND_TAX_AMT_F())
            {
            ...
            {
                A20_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A20_PAY_INCOME_TAX_AMT.EditValue);
                A20_PAY_INCOME_TAX_AMT.EditValue = 0;
            }
        ...
        private void CAL_A30_THIS_REFUND_TAX_AMT()
        {
            ...
            else if (iConv.ISDecimaltoZero(A30_PAY_INCOME_TAX_AMT.EditValue) > NEXT_REFUND_TAX_AMT_F())
            {
            ...
            {
                A30_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A30_PAY_INCOME_TAX_AMT.EditValue);
                A30_PAY_INCOME_TAX_AMT.EditValue = 0;
            }
            //농특세
            if (NEXT_REFUND_TAX_AMT_F() <= 0)
            ...
            else if (iConv.ISDecimaltoZero(A30_PAY_SP_TAX_AMT.EditValue) > NEXT_REFUND_TAX_AMT_F())
            {
                A30_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A30_THIS_REFUND_TAX_AMT.EditValue) +
                                                    NEXT_REFUND_TAX_AMT_F();
                A30_PAY_SP_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A30_PAY_SP_TAX_AMT.EditValue) -
                                                    iConv.ISDecimaltoZero(A30_THIS_REFUND_TAX_AMT.EditValue);
            }
            else if (iConv.ISDecimaltoZero(A30_PAY_SP_TAX_AMT.EditValue) < NEXT_REFUND_TAX_AMT_F())
            {
        ...
        private void CAL_A40_THIS_REFUND_TAX_AMT()
        {
            ...
            else if (iConv.ISDecimaltoZero(A40_PAY_INCOME_TAX_AMT.EditValue) > NEXT_REFUND_TAX_AMT_F())
            {
            ...
            {
                A40_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A40_PAY_INCOME_TAX_AMT.EditValue);
                A40_PAY_INCOME_TAX_AMT.EditValue = 0;
            }
        ...
        private void CAL_A47_THIS_REFUND_TAX_AMT()
        {
            ...
            else if (iConv.ISDecimaltoZero(A47_PAY_INCOME_TAX_AMT.EditValue) > NEXT_REFUND_TAX_AMT_F())
            {
            ...
            {
                A47_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A47_PAY_INCOME_TAX_AMT.EditValue);
                A47_PAY_INCOME_TAX_AMT.EditValue = 0;
            }
        ...
        private void CAL_A50_THIS_REFUND_TAX_AMT()
        {
            ...
            else if (iConv.ISDecimaltoZero(A50_PAY_INCOME_TAX_AMT.EditValue) > NEXT_REFUND_TAX_AMT_F())
            {
            ...
            {
                A50_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A50_PAY_INCOME_TAX_AMT.EditValue);
                A50_PAY_INCOME_TAX_AMT.EditValue = 0;
            }
            //농특세
            if (NEXT_REFUND_TAX_AMT_F() <= 0)
            ...
            else if (iConv.ISDecimaltoZero(A50_PAY_SP_TAX_AMT.EditValue) > NEXT_REFUND_TAX_AMT_F())
            {
                A50_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A50_THIS_REFUND_TAX_AMT.EditValue) +
                                                    NEXT_REFUND_TAX_AMT_F();
                A50_PAY_SP_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A50_PAY_SP_TAX_AMT.EditValue) -
                                                    iConv.ISDecimaltoZero(A50_THIS_REFUND_TAX_AMT.EditValue);
            }
            else if (iConv.ISDecimaltoZero(A50_PAY_SP_TAX_AMT.EditValue) < NEXT_REFUND_TAX_AMT_F())
            {
        ...
        private void CAL_A60_THIS_REFUND_TAX_AMT()
        {
            ...
            else if (iConv.ISDecimaltoZero(A60_PAY_INCOME_TAX_AMT.EditValue) > NEXT_REFUND_TAX_AMT_F())
            {
            ...
            {
                A60_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A60_PAY_INCOME_TAX_AMT.EditValue);
                A60_PAY_INCOME_TAX_AMT.EditValue = 0;
            }
            //농특세
            if (NEXT_REFUND_TAX_AMT_F() <= 0)
            ...
            else if (iConv.ISDecimaltoZero(A60_PAY_SP_TAX_AMT.EditValue) > NEXT_REFUND_TAX_AMT_F())
            {
                A60_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A60_THIS_REFUND_TAX_AMT.EditValue) +
                                                    NEXT_REFUND_TAX_AMT_F();
                A60_PAY_SP_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A60_PAY_SP_TAX_AMT.EditValue) -
                                                iConv.ISDecimaltoZero(A60_THIS_REFUND_TAX_AMT.EditValue);
            }
            else if (iConv.ISDecimaltoZero(A60_PAY_SP_TAX_AMT.EditValue) < NEXT_REFUND_TAX_AMT_F())
            {
        ...
        private void CAL_A69_THIS_REFUND_TAX_AMT()
        {
            ...
            else if (iConv.ISDecimaltoZero(A69_PAY_INCOME_TAX_AMT.EditValue) > NEXT_REFUND_TAX_AMT_F())
            {
            ...
            {
                A69_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A69_PAY_INCOME_TAX_AMT.EditValue);
                A69_PAY_INCOME_TAX_AMT.EditValue = 0;
            }
        ...
        private void CAL_A70_THIS_REFUND_TAX_AMT()
        {
            ...
            else if (iConv.ISDecimaltoZero(A70_PAY_INCOME_TAX_AMT.EditValue) > NEXT_REFUND_TAX_AMT_F())
            {
            ...
            {
                A70_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A70_PAY_INCOME_TAX_AMT.EditValue);
                A70_PAY_INCOME_TAX_AMT.EditValue = 0;
            }
        ...
        private void CAL_A80_THIS_REFUND_TAX_AMT()
        {
            ...
            else if (iConv.ISDecimaltoZero(A80_PAY_INCOME_TAX_AMT.EditValue) > NEXT_REFUND_TAX_AMT_F())
            {
            ...
            {
                A80_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A80_PAY_INCOME_TAX_AMT.EditValue);
                A80_PAY_INCOME_TAX_AMT.EditValue = 0;
            }
        ...
        private void CAL_A90_THIS_REFUND_TAX_AMT()
        {
            ...
            else if (iConv.ISDecimaltoZero(A90_PAY_INCOME_TAX_AMT.EditValue) > NEXT_REFUND_TAX_AMT_F())
            {
            ...
            {
                A90_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A90_PAY_INCOME_TAX_AMT.EditValue);
                A90_PAY_INCOME_TAX_AMT.EditValue = 0;
            }
            //농특세
            if (NEXT_REFUND_TAX_AMT_F() <= 0)
            ...
            else if (iConv.ISDecimaltoZero(A90_PAY_SP_TAX_AMT.EditValue) > NEXT_REFUND_TAX_AMT_F())
            {
                A90_THIS_REFUND_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A90_THIS_REFUND_TAX_AMT.EditValue) +
                                                    NEXT_REFUND_TAX_AMT_F();
                A90_PAY_SP_TAX_AMT.EditValue = iConv.ISDecimaltoZero(A90_PAY_SP_TAX_AMT.EditValue) -
                                                    iConv.ISDecimaltoZero(A90_THIS_REFUND_TAX_AMT.EditValue); ;
            }
            else if (iConv.ISDecimaltoZero(A90_PAY_SP_TAX_AMT.EditValue) < NEXT_REFUND_TAX_AMT_F())
            {
