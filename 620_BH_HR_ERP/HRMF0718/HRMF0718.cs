...
namespace HRMF0718
{
    public partial class HRMF0718 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public HRMF0718(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void Search_DB()
        {
            ...
            {
                IDA_YEAR_READJUST_LIST.Fill();
                IGR_YEAR_READJUST_LIST.Focus();
            }
        }
        ...
        //        // open해야 할 파일명 지정.
        //        //-------------------------------------------------------------------------------------
        //        xlPrinting.OpenFileNameExcel = "HRMF0718_001.xls";
        //        //-------------------------------------------------------------------------------------
        //        // 파일 오픈.
        //        //-------------------------------------------------------------------------------------
        ...
        private void HRMF0718_Load(object sender, EventArgs e)
        {
            // Lookup SETTING
        ...
        private void HRMF0718_Shown(object sender, EventArgs e)
        {
