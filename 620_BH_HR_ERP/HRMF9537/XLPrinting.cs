...
namespace HRMF9537
{
    public class XLPrinting
    {
        ...
        private void SetArray2(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, out int[] pGridColumn, out int[] pXLColumn)
        {
            ...
            pGridColumn[45] = pGrid.GetColumnToIndex("");                    //
            ...
            pGridColumn[49] = pGrid.GetColumnToIndex("D07");                 //건강보험정산
            pGridColumn[50] = pGrid.GetColumnToIndex("");                    //
        ...
        private void XLHeader(int pXLine, string pUserName, string pPrintingDateTime, string pYYYYMM, string pWageTypeName)
        {
            bool vIsNull = false;
            int vXLine = pXLine + 1;
        ...
        public int LineWrite(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, string pUserName, string pCorporationName, string pYYYYMM, string pWageTypeName)
        {
            mPageNumber = 0;
            ...
            try
            {
                ...
                XLHeader(1, mUserName, mPringingDateTime, mYYYYMM, mWageTypeName);
