...
namespace HRMF9537
{
    public partial class HRMF9537 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public HRMF9537(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void HRMF9537_Load(object sender, EventArgs e)
        {
        ...
        private void XLPrinting1(string pOutChoice)
        {
            ...
            {
                //-------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "HRMF9537_001.xls";
                ...
                if (IsOpen == true)
                {
                    ...
                    {
                        xlPrinting.SAVE("BH_PAY_"); //저장 파일명
                    }
                    //-------------------------------------------------------------------------
                }
                else
