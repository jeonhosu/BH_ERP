...
-- 자산변동 내역.            
  ...
  PROCEDURE ASSET_HISTORY_INSERT
            ...
            , P_DEPT_ID                  IN FI_ASSET_HISTORY.DEPT_ID%TYPE
...
-- 고정자산 변동내역 수정.
  PROCEDURE ASSET_HISTORY_UPDATE
            ...
            , W_ORG_ID                   IN FI_ASSET_HISTORY.ORG_ID%TYPE
            , P_CHARGE_DATE              IN FI_ASSET_HISTORY.CHARGE_DATE%TYPE
            , P_ASSET_ID                 IN FI_ASSET_HISTORY.ASSET_ID%TYPE
            , P_CHARGE_ID                IN FI_ASSET_HISTORY.CHARGE_ID%TYPE
            , P_CURRENCY_CODE            IN FI_ASSET_HISTORY.CURRENCY_CODE%TYPE
            ...
            , P_BF_DEPT_ID               IN FI_ASSET_HISTORY.BF_DEPT_ID%TYPE
...
-- 자산변동 내역 전체.
  ...
  BEGIN
    OPEN P_CURSOR FOR
      SELECT AC.ASSET_CATEGORY_NAME
           ...
           , AH.QTY
           , AH.DEPT_ID
           , FI_DEPT_MASTER_G.DEPT_NAME_F(AH.DEPT_ID) AS DEPT_NAME
           , AH.LOCATION_ID
           ...
           , AH.BF_QTY
           , AH.BF_DEPT_ID
           , FI_DEPT_MASTER_G.DEPT_NAME_F(AH.BF_DEPT_ID) AS BF_DEPT_NAME
           , AH.BF_LOCATION_ID
      ...
      ORDER BY AC.ASSET_CATEGORY_CODE, AM.ASSET_CODE, AH.HISTORY_NUM  
      ;  
  ...
  AS
    ...
    V_BF_DEPT_ID          FI_ASSET_HISTORY.BF_DEPT_ID%TYPE;
    ...
    -- 신규--.
      ...
      -- 자산 폐기/매각.
        UPDATE FI_ASSET_MASTER AM
          SET AM.MANAGE_DEPT_ID     = P_DEPT_ID
            , AM.LOCATION_ID        = P_LOCATION_ID
