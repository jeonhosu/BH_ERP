  ...
  BEGIN
    OPEN P_CURSOR FOR
      SELECT SEU.SLIP_DATE
           ...
           , SEU.MANAGEMENT1
           , FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_F( AC.ACCOUNT_CONTROL_ID
                                                , 'REFER1_ID'
                                                , SEU.MANAGEMENT1
  ...
  BEGIN
    OPEN P_CURSOR FOR
      SELECT SEU.SLIP_DATE
           ...
           , SEU.GL_CURRENCY_AMOUNT
           , SEU.MANAGEMENT1
           , NVL(FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F( AC.ACCOUNT_CONTROL_ID
                                                        , 'REFER1_ID'
                                                        , SEU.MANAGEMENT1
                                                        , SEU.SOB_ID), SEU.MANAGEMENT1) AS MANAGEMENT1_DESC
           , SEU.MANAGEMENT2
           , NVL(FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F( AC.ACCOUNT_CONTROL_ID
                                                        , 'REFER2_ID'
                                                        , SEU.MANAGEMENT2
                                                        , SEU.SOB_ID), SEU.MANAGEMENT2) AS MANAGEMENT2_DESC
           , SEU.REFER1
           , NVL(FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F( AC.ACCOUNT_CONTROL_ID
                                                        , 'REFER3_ID'
                                                        , SEU.REFER1
                                                        , SEU.SOB_ID), SEU.REFER1) AS REFER1_DESC
           , SEU.REFER2
           , NVL(FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F( AC.ACCOUNT_CONTROL_ID
                                                        , 'REFER4_ID'
                                                        , SEU.REFER2
                                                        , SEU.SOB_ID), SEU.REFER2) AS REFER2_DESC
           , SEU.REFER3
           , NVL(FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F( AC.ACCOUNT_CONTROL_ID
                                                        , 'REFER5_ID'
                                                        , SEU.REFER3
                                                        , SEU.SOB_ID), SEU.REFER3) AS REFER3_DESC
           , SEU.REFER4
           , NVL(FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F( AC.ACCOUNT_CONTROL_ID
                                                        , 'REFER6_ID'
                                                        , SEU.REFER4
                                                        , SEU.SOB_ID), SEU.REFER4) AS REFER4_DESC
           , SEU.REFER5
           , NVL(FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F( AC.ACCOUNT_CONTROL_ID
                                                        , 'REFER7_ID'
                                                        , SEU.REFER5
                                                        , SEU.SOB_ID), SEU.REFER5) AS REFER5_DESC
           , SEU.REFER6
           , NVL(FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F( AC.ACCOUNT_CONTROL_ID
                                                        , 'REFER8_ID'
                                                        , SEU.REFER6
                                                        , SEU.SOB_ID), SEU.REFER6) AS REFER6_DESC
           , SEU.REFER7
           , NVL(FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F( AC.ACCOUNT_CONTROL_ID
                                                        , 'REFER9_ID'
                                                        , SEU.REFER7
                                                        , SEU.SOB_ID), SEU.REFER7) AS REFER7_DESC
           , SEU.REFER8
           , NVL(FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F( AC.ACCOUNT_CONTROL_ID
                                                        , 'REFER10_ID'
                                                        , SEU.REFER8
                                                        , SEU.SOB_ID), SEU.REFER8) AS REFER8_DESC
           , SEU.REFER9
           , NVL(FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F( AC.ACCOUNT_CONTROL_ID
                                                        , 'REFER11_ID'
                                                        , SEU.REFER9
                                                        , SEU.SOB_ID), SEU.REFER9) AS REFER9_DESC
           , SEU.REFER10
           , NVL(FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F( AC.ACCOUNT_CONTROL_ID
                                                        , 'REFER12_ID'
                                                        , SEU.REFER10
                                                        , SEU.SOB_ID), SEU.REFER10) AS REFER10_DESC
           , SEU.REFER11
           , NVL(FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F( AC.ACCOUNT_CONTROL_ID
                                                        , 'REFER13_ID'
                                                        , SEU.REFER11
                                                        , SEU.SOB_ID), SEU.REFER11) AS REFER11_DESC
           , SEU.REFER12
           , NVL(FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F( AC.ACCOUNT_CONTROL_ID
                                                        , 'REFER14_ID'
                                                        , SEU.REFER12
                                                        , SEU.SOB_ID), SEU.REFER12) AS REFER12_DESC
           , SEU.REMARK
           , SEU.SLIP_YN
