...
-- 관리항목명 조회.
  PROCEDURE SELECT_MANAGEMENT_PROMPT
            ( P_CURSOR3              OUT TYPES.TCURSOR3
...
-- 계정 통제관리항목 필드값 DESCRIPTION, DESCRIPTION이 없으면 CODE 값 리턴.
  FUNCTION CONTROL_ITEM_F
          ( W_ACCOUNT_CONTROL_ID  IN FI_ACCOUNT_CONTROL.ACCOUNT_CONTROL_ID%TYPE
          , W_REFER_FIELD         IN VARCHAR2
          , W_REFER_VAULE         IN VARCHAR2
          , W_SOB_ID              IN FI_ACCOUNT_CONTROL.SOB_ID%TYPE
...
-- 계정 통제관리항목 DESCRIPTION.
  FUNCTION ITEM_DESC_F
          ( W_LOOKUP_TYPE         IN VARCHAR2
          , W_REFER_VAULE         IN VARCHAR2
          , W_SOB_ID              IN FI_ACCOUNT_CONTROL.SOB_ID%TYPE
          ) RETURN VARCHAR2;
...
---------------------------------------------------------------------------------------------------
-- 전표 계정 관리항목 검증 : 메시지 리턴.
  FUNCTION ACCOUNT_VALIDATE_F
...
-- 전표 계정 관리항목 검증 : 참/거짓 리턴.
  FUNCTION ACCOUNT_VALIDATE_BOOL_F
          ( P_SOB_ID                     IN FI_SLIP_LINE.SOB_ID%TYPE
          , P_ORG_ID                     IN FI_SLIP_LINE.ORG_ID%TYPE
          , P_ACCOUNT_CONTROL_ID         IN FI_SLIP_LINE.ACCOUNT_CONTROL_ID%TYPE
          , P_ACCOUNT_CODE               IN FI_SLIP_LINE.ACCOUNT_CODE%TYPE
...
--임동언 추가(2011-11-09)
--원장관리 프로그램 등의 계정과목 POPUP에 사용됨.
PROCEDURE POP_ACCOUNT( 
      P_CURSOR          OUT TYPES.TCURSOR
    , W_SOB_ID          IN  FI_ACCOUNT_CONTROL.SOB_ID%TYPE
    , W_ORG_ID          IN  FI_ACCOUNT_CONTROL.ORG_ID%TYPE
    , W_ACCOUNT_SET_ID  IN  FI_ACCOUNT_CONTROL.ACCOUNT_SET_ID%TYPE
...
--         AND AC.BUDGET_CONTROL_FLAG     = DECODE(W_ACCOUNT_DR_CR, '1', 'Y', 'N')
         ...
         AND AC.EFFECTIVE_DATE_FR       <= NVL(V_STD_DATE, AC.EFFECTIVE_DATE_FR)
         AND (AC.EFFECTIVE_DATE_TO IS NULL OR AC.EFFECTIVE_DATE_TO >= NVL(V_STD_DATE, AC.EFFECTIVE_DATE_TO)) 
         AND AC.ACCOUNT_CODE            NOT IN('1110201','1110100','1110101','1110200','1110301','1110302','1110303')
      ORDER BY AC.ACCOUNT_CODE
      ;
...
-- 관리항목명 조회.
  ...
  BEGIN
    OPEN P_CURSOR3 FOR
      SELECT MC.SOB_ID
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '01', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_01
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '02', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_02
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '03', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_03
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '04', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_04
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '05', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_05
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '06', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_06
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '07', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_07
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '08', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_08
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '09', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_09
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '10', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_10
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '11', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_11
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '12', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_12
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '13', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_13
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '14', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_14
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '15', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_15
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '16', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_16
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '17', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_17
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '18', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_18
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '19', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_19
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '20', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_20
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '21', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_21
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '22', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_22
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '23', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_23
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '24', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_24
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '25', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_25
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '26', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_26
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '27', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_27
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '28', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_28
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '29', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_29
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '30', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_30
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '31', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_31
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '32', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_32
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '33', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_33
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '34', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_34
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '35', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_35
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '36', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_36
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '37', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_37
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '38', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_38
          , NVL(MAX(DECODE(MC.MANAGEMENT_CODE, '39', MC.MANAGEMENT_NAME)), ':=') AS MANAGEMENT_39
       FROM FI_MANAGEMENT_CODE_V MC
     WHERE MC.SOB_ID              = P_SOB_ID
     GROUP BY MC.SOB_ID
     ;
  END SELECT_MANAGEMENT_PROMPT;
  ...
  BEGIN
    ...
    -- 통화.
      OPEN P_CURSOR3 FOR
        SELECT EC.CURRENCY_CODE  AS MANAGEMENT_CODE
            , EC.CURRENCY_CODE AS MANAGEMENT_NAME
    ...
    -- 타계정구분.
      OPEN P_CURSOR3 FOR
        ...
        ORDER BY FI.SORT_NUM, FI.CODE
        ;
     ELSIF V_LOOKUP_TYPE = 'LC_NO' THEN
    -- L/C 번호.
      OPEN P_CURSOR3 FOR
        SELECT LM.LC_NUM AS MANAGEMENT_CODE
             , FB.BANK_NAME || '(' || TO_CHAR(LM.OPEN_AMOUNT, 'FM999,999,999,999,999') || ')' AS MANAGEMENT_NAME
             , SC.SUPP_CUST_NAME || '(' || TO_CHAR(LM.OPEN_DATE, 'YYYY-MM-DD') || '~' || TO_CHAR(LM.DUE_DATE, 'YYYY-MM-DD') ||')' AS MANAGEMENT_DESC
        ...
        WHERE LM.BANK_ID                  = FB.BANK_ID
          ...
          AND LM.OPEN_DATE                <= DECODE(W_INQURIY_VALUE, NULL, V_STD_DATE, TO_DATE(W_INQURIY_VALUE, 'YYYY-MM-DD'))
          AND (LM.DUE_DATE IS NULL OR LM.DUE_DATE >= DECODE(W_INQURIY_VALUE, NULL, V_STD_DATE, TO_DATE(W_INQURIY_VALUE, 'YYYY-MM-DD')))
        ORDER BY LM.LC_NUM
        ;
    ELSE
      OPEN P_CURSOR3 FOR
  ...
  BEGIN
    ...
    -- 자금이체.
      OPEN P_CURSOR3 FOR
        ...
        ORDER BY FI.SORT_NUM, FI.CODE
        ;
    ELSIF W_LOOKUP_TYPE = 'VAT_CLASS' THEN
    -- 계산서 형태.
      OPEN P_CURSOR3 FOR
        SELECT FI.CODE AS MANAGEMENT_CODE
             , FI.CODE_NAME AS MANAGEMENT_NAME
        ...
        ORDER BY FI.SORT_NUM, FI.CODE
        ;
    ELSIF W_LOOKUP_TYPE = 'VAT_TYPE_AP' THEN
    -- 부가세대급금
      OPEN P_CURSOR3 FOR
        SELECT FI.CODE AS MANAGEMENT_CODE
             , FI.CODE_NAME AS MANAGEMENT_NAME
        ...
        ORDER BY FI.SORT_NUM, FI.CODE
        ;
    ELSIF W_LOOKUP_TYPE = 'VAT_TYPE_AR' THEN
    -- 부가세예수금
      OPEN P_CURSOR3 FOR
        SELECT FI.CODE AS MANAGEMENT_CODE
             , FI.CODE_NAME AS MANAGEMENT_NAME
    ...
    -- 통화.
      OPEN P_CURSOR3 FOR
        ...
        ORDER BY EC.CURRENCY_CODE
        ;  
    ELSIF W_LOOKUP_TYPE = 'SCHEDULE_REPORT_OMIT' THEN
    -- 예정신고누락분여부.
      OPEN P_CURSOR3 FOR
        SELECT FI.CODE AS MANAGEMENT_CODE
             , FI.CODE_NAME AS MANAGEMENT_NAME
        ...
        ORDER BY FI.SORT_NUM, FI.CODE
        ;
    ELSIF W_LOOKUP_TYPE = 'MODIFY_TAX_REASON' THEN
    -- 수정전자세금계산서사유구분.
      OPEN P_CURSOR3 FOR
        SELECT FI.CODE AS MANAGEMENT_CODE
             , FI.CODE_NAME AS MANAGEMENT_NAME
        ...
        ORDER BY FI.SORT_NUM, FI.CODE
        ;
    ELSIF W_LOOKUP_TYPE = 'OTHER_ACCOUNT_GB' THEN
    -- 타계정구분.
      OPEN P_CURSOR3 FOR
        SELECT FI.CODE AS MANAGEMENT_CODE
             , FI.CODE_NAME AS MANAGEMENT_NAME
        ...
        ORDER BY FI.SORT_NUM, FI.CODE
        ;
     ELSIF W_LOOKUP_TYPE = 'LC_NO' THEN
    -- L/C 번호.
      OPEN P_CURSOR3 FOR
        SELECT LM.LC_NUM AS MANAGEMENT_CODE
             , FB.BANK_NAME || '(' || TO_CHAR(LM.OPEN_AMOUNT, 'FM999,999,999,999,999') || ')' AS MANAGEMENT_NAME
        ...
        WHERE LM.BANK_ID                  = FB.BANK_ID
          ...
          AND LM.SOB_ID                   = W_SOB_ID
/*           AND LM.OPEN_DATE                <= DECODE(W_INQURIY_VALUE, NULL, V_STD_DATE, TO_DATE(W_INQURIY_VALUE, 'YYYY-MM-DD'))
         AND (LM.DUE_DATE IS NULL OR LM.DUE_DATE >= DECODE(W_INQURIY_VALUE, NULL, V_STD_DATE, TO_DATE(_INQURIY_VALUE, 'YYYY-MM-DD')))*/
        ORDER BY LM.LC_NUM
        ;
    ELSE
      OPEN P_CURSOR3 FOR
...
-- 계정 통제관리항목 필드값 DESCRIPTION.
  ...
  BEGIN
    ...
    V_CONTROL_ITEM_DESC := ITEM_DESC_F
                            ( W_LOOKUP_TYPE         => V_LOOKUP_TYPE
                            , W_REFER_VAULE         => W_REFER_VAULE
                            , W_SOB_ID              => W_SOB_ID
                            );
...
-- 계정 통제관리항목 필드값 DESCRIPTION, DESCRIPTION이 없으면 CODE 값 리턴.
  ...
  AS
    V_LOOKUP_TYPE                 FI_COMMON.VALUE1%TYPE := NULL;
    V_CONTROL_ITEM                VARCHAR2(200) := NULL;
  BEGIN
    -- LOOKUP 타입 조회.
    V_LOOKUP_TYPE := CONTROL_ITEM_LOOKUP_TYPE_F ( W_ACCOUNT_CONTROL_ID => W_ACCOUNT_CONTROL_ID
                                                , W_REFER_FIELD => W_REFER_FIELD
...
--    RAISE_APPLICATION_ERROR(-20001, W_ACCOUNT_CONTROL_ID || '/' || W_ACCOUNT_DR_CR || '/' || V_LOOKUP_TYPE || '/ ' || W_MANAGEMENT_FIELD || '/ ' || W_MANAGEMENT_VAULE);
    IF V_LOOKUP_TYPE IS NULL THEN
      V_CONTROL_ITEM := W_REFER_FIELD;
    ELSE
      V_CONTROL_ITEM := ITEM_DESC_F
                          ( W_LOOKUP_TYPE         => V_LOOKUP_TYPE
                          , W_REFER_VAULE         => W_REFER_VAULE
                          , W_SOB_ID              => W_SOB_ID
                          );
    END IF;
    RETURN V_CONTROL_ITEM;
  END CONTROL_ITEM_F;
...
-- 계정 통제관리항목 DESCRIPTION.
  ...
  BEGIN
    ...
    -- 계좌.
      BEGIN
        SELECT BA.BANK_ACCOUNT_NAME AS MANAGEMENT_NAME
          INTO V_CONTROL_ITEM_DESC
          FROM FI_BANK_ACCOUNT_TLV BA
             , FI_BANK FB
         WHERE BA.BANK_ID                 = FB.BANK_ID
    ...
    -- 지급어음 리스트.
      ...
      EXCEPTION WHEN OTHERS THEN
        NULL;
      END;
    ELSIF W_LOOKUP_TYPE = 'RECEIVEABLE_BILL' THEN
    -- 받을어음 리스트.
      BEGIN
    ...
    -- 통화.
      BEGIN
        SELECT EC.CURRENCY_CODE AS MANAGEMENT_NAME
         INTO V_CONTROL_ITEM_DESC
         FROM EAPP_CURRENCY     EC
        WHERE EC.SOB_ID             = W_SOB_ID
          AND EC.ORG_ID             = FI_COMMON_G.OPERATING_ORG_F(W_SOB_ID)
          AND EC.CURRENCY_CODE      = W_REFER_VAULE
        ;
      EXCEPTION WHEN OTHERS THEN
        NULL;
      END;
    ...
    -- L/C 번호(해당번호 표시).
      BEGIN
        SELECT LM.LC_NUM AS MANAGEMENT_NAME
          INTO V_CONTROL_ITEM_DESC
          FROM FI_LC_MASTER LM
        WHERE LM.SOB_ID                   = W_SOB_ID
          AND LM.LC_NUM                   = W_REFER_VAULE
        ;
      EXCEPTION WHEN OTHERS THEN
        NULL;
      END;
...
---------------------------------------------------------------------------------------------------
-- 전표 계정 관리항목 검증 : 메시지 리턴 - 필수여부, 룩업데이터 검증.
  FUNCTION ACCOUNT_VALIDATE_F
          ( P_SOB_ID                     IN FI_SLIP_LINE.SOB_ID%TYPE
          , P_ORG_ID                     IN FI_SLIP_LINE.ORG_ID%TYPE
          , P_ACCOUNT_CONTROL_ID         IN FI_SLIP_LINE.ACCOUNT_CONTROL_ID%TYPE
  ...
  AS
    ...
    V_REQUIRE_VALIDATE      VARCHAR2(50) := NULL;
    V_DATA_VALIDATE         VARCHAR2(50) := NULL;
    V_ACCOUNT_NO_SET        VARCHAR2(50) := NULL;
  BEGIN
    V_MESSAGE := NULL;
    BEGIN
      SELECT AC.ACCOUNT_CODE
           , CASE
               WHEN AC.REFER1_ID IS NULL AND P_MANAGEMENT1 IS NOT NULL THEN '1'
               WHEN AC.REFER2_ID IS NULL AND P_MANAGEMENT2 IS NOT NULL THEN '2'
               WHEN AC.REFER3_ID IS NULL AND P_REFER1 IS NOT NULL THEN '3'
               WHEN AC.REFER4_ID IS NULL AND P_REFER2 IS NOT NULL THEN '4'
               WHEN AC.REFER5_ID IS NULL AND P_REFER3 IS NOT NULL THEN '5'
               WHEN AC.REFER6_ID IS NULL AND P_REFER4 IS NOT NULL THEN '6'
               WHEN AC.REFER7_ID IS NULL AND P_REFER5 IS NOT NULL THEN '7'
               WHEN AC.REFER8_ID IS NULL AND P_REFER6 IS NOT NULL THEN '8'
               WHEN AC.REFER9_ID IS NULL AND P_REFER7 IS NOT NULL THEN '9'
               WHEN AC.REFER10_ID IS NULL AND P_REFER8 IS NOT NULL THEN '10'
               WHEN AC.REFER11_ID IS NULL AND P_REFER9 IS NOT NULL THEN '11'
               WHEN AC.REFER12_ID IS NULL AND P_REFER10 IS NOT NULL THEN '12'
               WHEN AC.REFER13_ID IS NULL AND P_REFER11 IS NOT NULL THEN '13'
               WHEN AC.REFER14_ID IS NULL AND P_REFER12 IS NOT NULL THEN '14'
               WHEN AC.REFER15_ID IS NULL AND P_REFER13 IS NOT NULL THEN '15'
               ELSE 'Y'
             END AS ACCOUNT_NO_SET  -- 미설정 관리항목에 데이터 입력되었을 경우.
           , CASE
               WHEN DECODE(P_ACCOUNT_DR_CR, '1', AC.DR_NEED_YN1, AC.CR_NEED_YN1) = 'Y' AND P_MANAGEMENT1 IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER1_ID)
               WHEN DECODE(P_ACCOUNT_DR_CR, '1', AC.DR_NEED_YN2, AC.CR_NEED_YN2) = 'Y' AND P_MANAGEMENT2 IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER2_ID)
               WHEN DECODE(P_ACCOUNT_DR_CR, '1', AC.DR_NEED_YN3, AC.CR_NEED_YN3) = 'Y' AND P_REFER1 IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER3_ID)
               WHEN DECODE(P_ACCOUNT_DR_CR, '1', AC.DR_NEED_YN4, AC.CR_NEED_YN4) = 'Y' AND P_REFER2 IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER4_ID)
               WHEN DECODE(P_ACCOUNT_DR_CR, '1', AC.DR_NEED_YN5, AC.CR_NEED_YN5) = 'Y' AND P_REFER3 IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER5_ID)
               WHEN DECODE(P_ACCOUNT_DR_CR, '1', AC.DR_NEED_YN6, AC.CR_NEED_YN6) = 'Y' AND P_REFER4 IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER6_ID)
               WHEN DECODE(P_ACCOUNT_DR_CR, '1', AC.DR_NEED_YN7, AC.CR_NEED_YN7) = 'Y' AND P_REFER5 IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER7_ID)
               WHEN DECODE(P_ACCOUNT_DR_CR, '1', AC.DR_NEED_YN8, AC.CR_NEED_YN8) = 'Y' AND P_REFER6 IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER8_ID)
               WHEN DECODE(P_ACCOUNT_DR_CR, '1', AC.DR_NEED_YN9, AC.CR_NEED_YN9) = 'Y' AND P_REFER7 IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER9_ID)
               WHEN DECODE(P_ACCOUNT_DR_CR, '1', AC.DR_NEED_YN10, AC.CR_NEED_YN10) = 'Y' AND P_REFER8 IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER10_ID)
               WHEN DECODE(P_ACCOUNT_DR_CR, '1', AC.DR_NEED_YN11, AC.CR_NEED_YN11) = 'Y' AND P_REFER9 IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER11_ID)
               WHEN DECODE(P_ACCOUNT_DR_CR, '1', AC.DR_NEED_YN12, AC.CR_NEED_YN12) = 'Y' AND P_REFER10 IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER12_ID)
               WHEN DECODE(P_ACCOUNT_DR_CR, '1', AC.DR_NEED_YN13, AC.CR_NEED_YN13) = 'Y' AND P_REFER11 IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER13_ID)
               WHEN DECODE(P_ACCOUNT_DR_CR, '1', AC.DR_NEED_YN14, AC.CR_NEED_YN14) = 'Y' AND P_REFER12 IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER14_ID)
               WHEN DECODE(P_ACCOUNT_DR_CR, '1', AC.DR_NEED_YN15, AC.CR_NEED_YN15) = 'Y' AND P_REFER13 IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER15_ID)
               ELSE 'Y'
             END AS REQUIRE_VALIDATE  -- 필수여부.
           , CASE
               WHEN P_MANAGEMENT1 IS NOT NULL 
                      AND FI_COMMON_G.ID_VALUE_F(AC.REFER1_ID, DECODE(P_ACCOUNT_DR_CR, '1', 'VALUE1', 'VALUE2')) = 'Y' 
                      AND FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F(AC.ACCOUNT_CONTROL_ID, 'REFER1_ID', P_MANAGEMENT1, AC.SOB_ID) IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER1_ID)
               WHEN P_MANAGEMENT2 IS NOT NULL 
                      AND FI_COMMON_G.ID_VALUE_F(AC.REFER2_ID, DECODE(P_ACCOUNT_DR_CR, '1', 'VALUE1', 'VALUE2')) = 'Y'
                      AND FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F(AC.ACCOUNT_CONTROL_ID, 'REFER2_ID', P_MANAGEMENT2, AC.SOB_ID) IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER2_ID)
               WHEN P_REFER1 IS NOT NULL
                      AND FI_COMMON_G.ID_VALUE_F(AC.REFER3_ID, DECODE(P_ACCOUNT_DR_CR, '1', 'VALUE1', 'VALUE2')) = 'Y' 
                      AND FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F(AC.ACCOUNT_CONTROL_ID, 'REFER3_ID', P_REFER1, AC.SOB_ID) IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER3_ID)
               WHEN P_REFER2 IS NOT NULL
                      AND FI_COMMON_G.ID_VALUE_F(AC.REFER4_ID, DECODE(P_ACCOUNT_DR_CR, '1', 'VALUE1', 'VALUE2')) = 'Y' 
                      AND FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F(AC.ACCOUNT_CONTROL_ID, 'REFER4_ID', P_REFER2, AC.SOB_ID) IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER4_ID)
               WHEN P_REFER3 IS NOT NULL
                      AND FI_COMMON_G.ID_VALUE_F(AC.REFER5_ID, DECODE(P_ACCOUNT_DR_CR, '1', 'VALUE1', 'VALUE2')) = 'Y' 
                      AND FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F(AC.ACCOUNT_CONTROL_ID, 'REFER5_ID', P_REFER3, AC.SOB_ID) IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER5_ID)
               WHEN P_REFER4 IS NOT NULL
                      AND FI_COMMON_G.ID_VALUE_F(AC.REFER6_ID, DECODE(P_ACCOUNT_DR_CR, '1', 'VALUE1', 'VALUE2')) = 'Y' 
                      AND FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F(AC.ACCOUNT_CONTROL_ID, 'REFER6_ID', P_REFER4, AC.SOB_ID) IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER6_ID)
               WHEN P_REFER5 IS NOT NULL 
                      AND FI_COMMON_G.ID_VALUE_F(AC.REFER7_ID, DECODE(P_ACCOUNT_DR_CR, '1', 'VALUE1', 'VALUE2')) = 'Y' 
                      AND FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F(AC.ACCOUNT_CONTROL_ID, 'REFER7_ID', P_REFER5, AC.SOB_ID) IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER7_ID)
               WHEN P_REFER6 IS NOT NULL
                      AND FI_COMMON_G.ID_VALUE_F(AC.REFER8_ID, DECODE(P_ACCOUNT_DR_CR, '1', 'VALUE1', 'VALUE2')) = 'Y' 
                      AND FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F(AC.ACCOUNT_CONTROL_ID, 'REFER8_ID', P_REFER6, AC.SOB_ID) IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER8_ID)
               WHEN P_REFER7 IS NOT NULL
                      AND FI_COMMON_G.ID_VALUE_F(AC.REFER9_ID, DECODE(P_ACCOUNT_DR_CR, '1', 'VALUE1', 'VALUE2')) = 'Y' 
                      AND FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F(AC.ACCOUNT_CONTROL_ID, 'REFER9_ID', P_REFER7, AC.SOB_ID) IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER9_ID)
               WHEN P_REFER8 IS NOT NULL
                      AND FI_COMMON_G.ID_VALUE_F(AC.REFER10_ID, DECODE(P_ACCOUNT_DR_CR, '1', 'VALUE1', 'VALUE2')) = 'Y' 
                      AND FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F(AC.ACCOUNT_CONTROL_ID, 'REFER10_ID', P_REFER8, AC.SOB_ID) IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER10_ID)
               WHEN P_REFER9 IS NOT NULL
                      AND FI_COMMON_G.ID_VALUE_F(AC.REFER11_ID, DECODE(P_ACCOUNT_DR_CR, '1', 'VALUE1', 'VALUE2')) = 'Y' 
                      AND FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F(AC.ACCOUNT_CONTROL_ID, 'REFER11_ID', P_REFER9, AC.SOB_ID) IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER11_ID)
               WHEN P_REFER10 IS NOT NULL
                      AND FI_COMMON_G.ID_VALUE_F(AC.REFER12_ID, DECODE(P_ACCOUNT_DR_CR, '1', 'VALUE1', 'VALUE2')) = 'Y' 
                      AND FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F(AC.ACCOUNT_CONTROL_ID, 'REFER12_ID', P_REFER10, AC.SOB_ID) IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER12_ID)
               WHEN P_REFER11 IS NOT NULL
                      AND FI_COMMON_G.ID_VALUE_F(AC.REFER13_ID, DECODE(P_ACCOUNT_DR_CR, '1', 'VALUE1', 'VALUE2')) = 'Y' 
                      AND FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F(AC.ACCOUNT_CONTROL_ID, 'REFER13_ID', P_REFER11, AC.SOB_ID) IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER13_ID)
               WHEN P_REFER12 IS NOT NULL
                      AND FI_COMMON_G.ID_VALUE_F(AC.REFER14_ID, DECODE(P_ACCOUNT_DR_CR, '1', 'VALUE1', 'VALUE2')) = 'Y' 
                      AND FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F(AC.ACCOUNT_CONTROL_ID, 'REFER14_ID', P_REFER12, AC.SOB_ID) IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER14_ID)
               WHEN P_REFER13 IS NOT NULL
                      AND FI_COMMON_G.ID_VALUE_F(AC.REFER15_ID, DECODE(P_ACCOUNT_DR_CR, '1', 'VALUE1', 'VALUE2')) = 'Y' 
                      AND FI_ACCOUNT_CONTROL_G.CONTROL_ITEM_DESC_F(AC.ACCOUNT_CONTROL_ID, 'REFER15_ID', P_REFER13, AC.SOB_ID) IS NULL THEN FI_COMMON_G.ID_NAME_F(AC.REFER15_ID)
               ELSE 'Y'
             END AS DATA_VALIDATE  
        INTO V_ACCOUNT_CODE, V_ACCOUNT_NO_SET, V_REQUIRE_VALIDATE, V_DATA_VALIDATE
        FROM FI_ACCOUNT_CONTROL AC
      WHERE AC.SOB_ID             = P_SOB_ID
        AND AC.ACCOUNT_CONTROL_ID = P_ACCOUNT_CONTROL_ID
      ;
    EXCEPTION WHEN OTHERS THEN
      V_MESSAGE := '-';
    END;
    IF V_MESSAGE = '-' OR (P_ACCOUNT_CODE IS NOT NULL AND P_ACCOUNT_CODE <> V_ACCOUNT_CODE) THEN
      V_MESSAGE := '[' || NVL(P_ACCOUNT_CODE, P_ACCOUNT_CONTROL_ID) || ']' || EAPP_MESSAGE_G.RETURN_TEXT_F(USERENV_G.GET_TERRITORY_S_F, 'FCM_10413', NULL);
    ELSIF V_ACCOUNT_NO_SET = 'Y' AND V_REQUIRE_VALIDATE = 'Y' AND V_DATA_VALIDATE = 'Y' THEN
      V_MESSAGE := NULL;
    ELSE
      IF V_ACCOUNT_NO_SET <> 'Y' THEN
        V_MESSAGE := '[' || V_ACCOUNT_CODE || ']' || EAPP_MESSAGE_G.RETURN_TEXT_F(USERENV_G.GET_TERRITORY_S_F, 'FCM_10380', '&&VALUE:=' || V_ACCOUNT_NO_SET);
      ELSIF V_REQUIRE_VALIDATE <> 'Y' THEN
        V_MESSAGE := '[' || V_ACCOUNT_CODE || ']' || EAPP_MESSAGE_G.RETURN_TEXT_F(USERENV_G.GET_TERRITORY_S_F, 'FCM_10378', '&&VALUE:=' || V_REQUIRE_VALIDATE);
      ELSIF V_DATA_VALIDATE <> 'Y' THEN
        V_MESSAGE := '[' || V_ACCOUNT_CODE || ']' || EAPP_MESSAGE_G.RETURN_TEXT_F(USERENV_G.GET_TERRITORY_S_F, 'FCM_10379', '&&VALUE:=' || V_DATA_VALIDATE);
      END IF;
    END IF;
    RETURN V_MESSAGE;
  END ACCOUNT_VALIDATE_F;
...
-- 전표 계정 관리항목 검증 : 참/거짓 리턴.
  ...
  BEGIN
    V_BOOLEAN := FALSE;
    -- 계정 관리항목 검증.
    V_MESSAGE := FI_ACCOUNT_CONTROL_G.ACCOUNT_VALIDATE_F
                  ( P_SOB_ID
                  , P_ORG_ID
                  , P_ACCOUNT_CONTROL_ID
                  , P_ACCOUNT_CODE
    ...
    IF V_MESSAGE IS NULL THEN
      ...
      RETURN V_BOOLEAN;
    ELSE
      RAISE_APPLICATION_ERROR(-20001, SUBSTR(V_MESSAGE, 1, 200));
      RETURN V_BOOLEAN;
    END IF;    
  END ACCOUNT_VALIDATE_BOOL_F;
...
BEGIN
    ...
    SELECT ACCOUNT_CODE, ACCOUNT_DESC
    FROM FI_ACCOUNT_CONTROL
    WHERE SOB_ID = W_SOB_ID
        AND ORG_ID = W_ORG_ID
        AND ACCOUNT_SET_ID = NVL(W_ACCOUNT_SET_ID, 10)
        --AND ENABLED_FLAG = 'Y'
        AND ACCOUNT_CODE >= NVL(W_ACCOUNT_CODE, ACCOUNT_CODE)
