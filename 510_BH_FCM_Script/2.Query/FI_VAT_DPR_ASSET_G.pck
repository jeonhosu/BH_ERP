...
/* Description  : 부가세 조회-건물등감가상각취득명세서 관리.
/*
/* Reference by :
/* Program History :
/*------------------------------------------------------------------------------
...
-- VAT 건물등감가상각취득명세서 상세명세서 UPDATE.
  ...
  BEGIN
    IF FI_VAT_DPR_ASSET_G.CLOSED_YN_F(W_DPR_ASSET_ID, P_SOB_ID) = 'Y' THEN
      RAISE_APPLICATION_ERROR(-20001, EAPP_MESSAGE_G.RETURN_TEXT_F(USERENV_G.GET_TERRITORY_S_F, 'EAPP_90007', '&&FIELD_NAME:=This Depreciation Asset(해당 감가상각 취득자산)'));
    END IF;
