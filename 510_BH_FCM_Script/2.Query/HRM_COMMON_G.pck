...
-- ID값 코드값 반환.
  FUNCTION GET_ID_F
            ...
            , W_WHERE               IN VARCHAR2
            , W_SOB_ID              IN HRM_COMMON.SOB_ID%TYPE
            , W_ORG_ID              IN HRM_COMMON.ORG_ID%TYPE DEFAULT NULL
            ) RETURN NUMBER;
...
-- 공통코드 ftp 정보.
  PROCEDURE FTP_INFO_P
            ...
            , O_FTP_TARGETPATH     OUT VARCHAR2
            , O_FTP_FILE_EXTENSION OUT VARCHAR2
            );
...
-- 공통코드 ftp 정보.
  ...
  BEGIN
    ...
    EXCEPTION WHEN OTHERS THEN
      ...
      O_FTP_TARGETPATH := NULL;
      O_FTP_FILE_EXTENSION := NULL;
    END;
