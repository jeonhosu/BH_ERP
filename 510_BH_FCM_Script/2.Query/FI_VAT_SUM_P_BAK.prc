    ...
    IF P_GB = 'I' THEN
      ...
      BEGIN
        SELECT MAX(DECODE(FMC.LOOKUP_TYPE, 'TAX_ELECTRO', SMI.MANAGEMENT_VALUE, NULL)) AS TAX_INVOICE_TYPE
          ...
          INTO V_TAX_INVOICE_TYPE, V_CREDITCARD_CODE, V_ISSUE_DATE, V_GL_AMOUNT, V_TAX_CODE, V_RESIDENT_REG_NUM
        ...
        WHERE SMI.MANAGEMENT_ID        = FMC.MANAGEMENT_ID
          ...
          AND FMC.LOOKUP_TYPE          IN('TAX_ELECTRO', 'CREDIT_CARD', 'VAT_ISSUE_DATE',
                                          'SUPPLY_AMOUNT', 'TAX_CODE', 'RESIDENT_REG_NUM',
