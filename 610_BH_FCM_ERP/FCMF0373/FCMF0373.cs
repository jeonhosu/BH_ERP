...
namespace FCMF0373
{
    public partial class FCMF0373 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0373(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void FCMF0373_Load(object sender, EventArgs e)
        {

        }

        private void FCMF0373_Shown(object sender, EventArgs e)
        {
