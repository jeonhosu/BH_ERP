...
namespace FCMF0704
{
    public class XLPrinting
    {
        ...
        private void SetArray1(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, out int[] pGDColumn, out int[] pXLColumn)
        {
            ...
            pGDColumn[0] = pGrid.GetColumnToIndex("HEADER_NAME");    //계정과목
            ...
            pGDColumn[5] = pGrid.GetColumnToIndex("CHANGE_AMOUNT");  //층감액
            pGDColumn[6] = pGrid.GetColumnToIndex("CHANGE_RATE");    //증감비

            mDrawLineif_ColumnIndex = pGrid.GetColumnToIndex("SUM_YN");    //합계 행의 Line Draw 여부
