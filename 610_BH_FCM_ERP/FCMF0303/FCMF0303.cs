...
namespace FCMF0303
{
    public partial class FCMF0303 : Office2007Form
    {
        ...
        {
            igrDPR_RATE.SetCellValue("DPR_TYPE", DPR_TYPE_0.EditValue);
            igrDPR_RATE.SetCellValue("DPR_TYPE_NAME", DPR_TYPE_NAME_0.EditValue);
        ...
        private void idaDPR_RATE_PreRowUpdate(ISPreRowUpdateEventArgs e)
        {
            ...
            if (iString.ISNull(e.Row["PROGRESS_YEAR"]) == string.Empty)
            {
