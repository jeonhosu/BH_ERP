...
namespace FCMF0763
{
    public class XLPrinting
    {
        ...
        private void SetArray1(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, out int[] pGDColumn, out int[] pXLColumn)
        {
            ...
            pGDColumn[1] = pGrid.GetColumnToIndex("THIS_MNS_AMT"); //당기 : 금액 : Decimal
            pGDColumn[2] = pGrid.GetColumnToIndex("THIS_AMT");     //당기 : 금액 : String
            pGDColumn[3] = pGrid.GetColumnToIndex("PRE_MNS_AMT");  //전기 : 금액 : Decimal
            pGDColumn[4] = pGrid.GetColumnToIndex("PRE_AMT");      //전기 : 금액 : String

            pXLColumn[0] = 2;  //계정과목    : String
            pXLColumn[1] = 14; //당기 : 금액 : Decimal
            pXLColumn[2] = 21; //당기 : 금액 : String
            pXLColumn[3] = 29; //전기 : 금액 : Decimal
            pXLColumn[4] = 36; //전기 : 금액 : String
        }
        ...
        private void XLHeader(InfoSummit.Win.ControlAdv.ISDataAdapter p_adapter_PRINT_TITLE)
        {
            ...
            try
            {
                ...
                if (vCountRow > 0)
                {
                    ...
                    //당기(예>제 13기 2011년 12월 31일 현재); 재무상태표에서 사용
                    ...
                    //전기(예>제 12기 2010년 12월 31일 현재); 재무상태표에서 사용
