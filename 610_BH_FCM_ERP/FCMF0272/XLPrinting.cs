...
namespace FCMF0272
{
    public class XLPrinting
    {
        ...
        private void SetArray1(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, out int[] pGDColumn)
        {
            ...
            pGDColumn[2] = pGrid.GetColumnToIndex("CUSTOMER_CD");
            pGDColumn[3] = pGrid.GetColumnToIndex("CUSTOMER_NM");
            pGDColumn[4] = pGrid.GetColumnToIndex("DR_AMT");
            pGDColumn[5] = pGrid.GetColumnToIndex("CR_AMT");
            pGDColumn[6] = pGrid.GetColumnToIndex("REMAIN_AMT");
        }
        ...
        private void SetArray2(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, out int[] pGDColumn)
        {
            ...
            // 그리드 or 아답터 위치.
            pGDColumn[0] = pGrid.GetColumnToIndex("GL_DATE");
            pGDColumn[1] = pGrid.GetColumnToIndex("ACCOUNT_CODE");
            pGDColumn[2] = pGrid.GetColumnToIndex("ACCOUNT_DESC");
            pGDColumn[3] = pGrid.GetColumnToIndex("REMARKS");
            pGDColumn[4] = pGrid.GetColumnToIndex("CUSTOMER_CD");
            pGDColumn[5] = pGrid.GetColumnToIndex("CUSTOMER_NM");
            pGDColumn[6] = pGrid.GetColumnToIndex("DR_AMT");
            pGDColumn[7] = pGrid.GetColumnToIndex("CR_AMT");
            pGDColumn[8] = pGrid.GetColumnToIndex("REMAIN_AMT");
        }
        ...
        public void HeaderWrite_2(object pPERIOD)
        {// 헤더 인쇄.
            int vXLine = 0;
            int vXLColumn = 0;
