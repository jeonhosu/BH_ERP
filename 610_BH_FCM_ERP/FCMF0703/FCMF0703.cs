...
namespace FCMF0703
{
    public partial class FCMF0703 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0703(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void ExportXL(ISGridAdvEx pGrid)
        {
            ...
            if (vCountRows > 0)
            {
                ...
                if (saveFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    string vOpenExcelFileName = "FCMF0703_002.xls";
        ...
        private void XLPrinting1(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid)
        {
            ...
            if (vCountRowGrid > 0)
            {
                ...
                {
                    //-------------------------------------------------------------------------------------
                    xlPrinting.OpenFileNameExcel = "FCMF0703_001.xls";
                    //-------------------------------------------------------------------------------------
        ...
        private void FCMF0703_Load(object sender, EventArgs e)
        {
        ...
        private void FCMF0703_Shown(object sender, EventArgs e)
        {
