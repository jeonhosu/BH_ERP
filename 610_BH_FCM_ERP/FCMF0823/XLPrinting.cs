    ...
    public class XLPrinting
    {
        ...
        {// 헤더 인쇄.
            ...
            try
            {
                ...
                vXLine = 3;
                vXLColumn = 13;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["FISCAL_TITLE"]);
                ...
                vXLColumn = 26;
                mPrinting.XLSetCell(vXLine, vXLColumn, pAdapter.CurrentRow["LOCATION"]);
        ...
        {// pGridRow : 그리드의 현재 읽는 행, pXLine : 엑셀의 인쇄해야 하는 행. pGDColumn : 그리드 위치, pXLColumn : 엑셀 위치.
            ...
            { // 타겟쉬트 Active.
                ...
                //35.농·어민 등에게 공급하는 농업용 · 축산업용 · 임업용 또는 어업용 기자재
                //-------------------------------------------------------------------
                vXLine = vXLine + 1;
                //-------------------------------------------------------------------
        ...
        private int CopyAndPaste(XL.XLPrint pPrinting, string pActiveSheet, int pPasteStartRow)
        {
            ...
            //XLPageNumber(pActiveSheet, mPageNumber);  //페이지수 인쇄 안함//
