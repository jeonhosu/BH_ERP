...
namespace FCMF0715
{
    public partial class FCMF0715 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0715(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void SetGridPeriod()
        {
            ...
            igrBALANCE_MS.GridAdvExColElement[2].HeaderElement[1].TL1_KR = iString.ISNull(mMonth);
        ...
        private void FCMF0715_Load(object sender, EventArgs e)
        {
            CompanySearch();
        }

        private void FCMF0715_Shown(object sender, EventArgs e)
        {
        ...
        private void XLPrinting(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, string pOutChoice)
        {
            ...
            if (vCountRowGrid > 0)
            {
                ...
                try
                {
                    ...
                    {
                        xlPrinting.OpenFileNameExcel = "FCMF0715_001.xls";
                    }
