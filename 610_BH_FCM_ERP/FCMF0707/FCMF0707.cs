...
namespace FCMF0707
{
    public partial class FCMF0707 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0707(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void FCMF0707_Load(object sender, EventArgs e)
        {
            CompanySearch();
        }

        private void FCMF0707_Shown(object sender, EventArgs e)
        {
        ...
        private void XLPrinting(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, string pOutChoice)
        {
            ...
            if (vCountRowGrid > 0)
            {
                ...
                try
                {
                    ...
                    {
                        xlPrinting.OpenFileNameExcel = "FCMF0707_001.xls";
                    }
