...
namespace FCMF0877
{
    public class XLPrinting
    {
        ...
        private void XLSUM(InfoSummit.Win.ControlAdv.ISGridAdvEx p_grid_UP_AR_SUM_VAT_TAX)
        {
            int vRow = 0;
            int vCountRow = 0;
            ...
            try
            {
                vCountRow = p_grid_UP_AR_SUM_VAT_TAX.RowCount;
                ...
                if (vCountRow > 0)
                {
                    ...
                    //매입처수 : 합계
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("TOTAL_CNT");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    ...
                    //매수 : 합계
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("TOTAL_REC");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    ...
                    //공급가액_조단위 : 합계
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("TOTAL_GL_1");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    ...
                    //공급가액_십억단위 : 합계
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("TOTAL_GL_2");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    ...
                    //공급가액_백만단위 : 합계
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("TOTAL_GL_3");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    ...
                    //공급가액_천단위 : 합계
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("TOTAL_GL_4");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    ...
                    //공급가액_원단위 : 합계
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("TOTAL_GL_5");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    ...
                    //세액_조단위 : 합계
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("TOTAL_VAT_1");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    ...
                    //세액_십억단위 : 합계
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("TOTAL_VAT_2");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    ...
                    //세액_백만단위 : 합계
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("TOTAL_VAT_3");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    ...
                    //세액_천단위 : 합계
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("TOTAL_VAT_4");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    ...
                    //세액_원단위 : 합계
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("TOTAL_VAT_5");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    ...
                    //매입처수 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("COM_CNT");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_COM_CNT;
                    IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                    if (IsConvert == true)
                    ...
                    //매수 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("COM_REC");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_COM_REC;
                    IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                    if (IsConvert == true)
                    ...
                    //공급가액_조단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("COM_GL_1");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_GL_JO;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //공급가액_십억단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("COM_GL_2");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_GL_UK;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //공급가액_백만단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("COM_GL_3");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_GL_MAN;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //공급가액_천단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("COM_GL_4");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_GL_CHUN;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //공급가액_원단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("COM_GL_5");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_GL_WON;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //세액_조단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("COM_VAT_1");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_VAT_JO;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //세액_십억단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("COM_VAT_2");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_VAT_UK;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //세액_백만단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("COM_VAT_3");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_VAT_MAN;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //세액_천단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("COM_VAT_4");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_VAT_CHUN;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //세액_원단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("COM_VAT_5");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_VAT_WON;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //매입처수 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("SN_CNT");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_COM_CNT;
                    IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                    if (IsConvert == true)
                    ...
                    //매수 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("SN_REC");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_COM_REC;
                    IsConvert = IsConvertNumber(vObject, out vConvertDecimal);
                    if (IsConvert == true)
                    ...
                    //공급가액_조단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("SN_GL_1");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_GL_JO;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //공급가액_십억단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("SN_GL_2");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_GL_UK;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //공급가액_백만단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("SN_GL_3");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_GL_MAN;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //공급가액_천단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("SN_GL_4");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_GL_CHUN;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //공급가액_원단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("SN_GL_5");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_GL_WON;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //세액_조단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("SN_VAT_1");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_VAT_JO;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //세액_십억단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("SN_VAT_2");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_VAT_UK;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //세액_백만단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("SN_VAT_3");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_VAT_MAN;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //세액_천단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("SN_VAT_4");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_VAT_CHUN;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
                    ...
                    //세액_원단위 : 전자
                    vGDColumnIndex = p_grid_UP_AR_SUM_VAT_TAX.GetColumnToIndex("SN_VAT_5");
                    vObject = p_grid_UP_AR_SUM_VAT_TAX.GetCellValue(vRow, vGDColumnIndex);
                    vXLColumn = vCol_VAT_WON;
                    IsConvert = IsConvertString(vObject, out vConvertString);
                    if (IsConvert == true)
        ...
        public int LineWrite(InfoSummit.Win.ControlAdv.ISGridAdvEx p_grid_UP_AR_SUM_VAT_TAX, InfoSummit.Win.ControlAdv.ISGridAdvEx p_grid_LIST_AR_SUM_VAT_TAX_2, InfoSummit.Win.ControlAdv.ISDataAdapter p_adapter_PRINT_SUM_VAT_TAX_TITLE)
        {
            mPageNumber = 0;
            ...
            try
            {
                int vTotal1ROW = p_grid_LIST_AR_SUM_VAT_TAX_2.RowCount;

                #region ----- Header/SUM Write ----

                XLHeader(p_adapter_PRINT_SUM_VAT_TAX_TITLE);
                XLSUM(p_grid_UP_AR_SUM_VAT_TAX);
                ...
                if (vTotal1ROW > 0)
                {
                    ...
                    SetArray1(p_grid_LIST_AR_SUM_VAT_TAX_2, out vGDColumn, out vXLColumn);
                    ...
                    for (int vRow1 = 0; vRow1 < vTotal1ROW; vRow1++)
                    {
                        ...
                        vPrintingLine = XLLine(p_grid_LIST_AR_SUM_VAT_TAX_2, vRow1, vPrintingLine, vGDColumn, vXLColumn);
