...
namespace FCMF0713
{
    public class XLPrinting
    {
        ...
        private void SetArray1(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, out int[] pGDColumn, out int[] pXLColumn)
        {
            ...
            pGDColumn[1] = pGrid.GetColumnToIndex("THIS_L_AMOUNT");    //금액
            pGDColumn[2] = pGrid.GetColumnToIndex("THIS_RATE");        //비율(%)
            pGDColumn[3] = pGrid.GetColumnToIndex("PREV_L_AMOUNT");    //금액
            pGDColumn[4] = pGrid.GetColumnToIndex("PREV_RATE");        //비율(%)
            pGDColumn[5] = pGrid.GetColumnToIndex("CHANGE_L_AMOUNT");  //층감액
            pGDColumn[6] = pGrid.GetColumnToIndex("CHANGE_RATE");      //증감율(%)
