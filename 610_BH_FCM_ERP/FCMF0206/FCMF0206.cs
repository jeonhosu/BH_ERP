...
namespace FCMF0206
{
    public partial class FCMF0206 : Office2007Form
    {
        ...
        public FCMF0206(Form pMainForm, ISAppInterface pAppInterface, object pSLIP_INTERFACE_HEADER_ID)
        {
            InitializeComponent();
            this.MdiParent = pMainForm;
            isAppInterfaceAdv1.AppInterface = pAppInterface;

            mHEADER_INTERFACE_ID = pSLIP_INTERFACE_HEADER_ID;
        }
        ...
        private void XLPrinting_1(string pOutChoice)
        {
            ...
            try
            {
                ...
                if (isOpen == true)
                {
                    ...
                    object vObject = H_SLIP_HEADER_ID.EditValue;
                    ...
                    if (vCountRow > 0)
                    {
                        vPageNumber = xlPrinting.LineWrite(idaSLIP_HEADER.OraSelectData, idaPRINT_SLIP_LINE.OraSelectData, vCurruntRow);
                    }
