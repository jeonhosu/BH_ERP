...
namespace FCMF0216
{
    public partial class FCMF0216 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0216(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
                    ...
                    if (vObject != null)
                    {
                        ...
                        if (IsConvert == true)
                        {
                            ...
                            if (vBoxCheck == vCheckedString)
                            {
                                ...
                                {
                                    //-------------------------------------------------------------------------------------
                                    xlPrinting.OpenFileNameExcel = "FCMF0216_001.xls";
                                    ...
                                    if (isOpen == true)
                                    {
                                        ...
                                        object vObject_GL_DATE = igrSLIP_LIST.GetCellValue("GL_DATE");
                                        object vObject_DEPT_ID = igrSLIP_LIST.GetCellValue("DEPT_ID"); 

                                        //현업 결재라인//
                                        idaDOC_APPROVAL_LINE.SetSelectParamValue("W_STD_DATE", vObject_GL_DATE);
                                        idaDOC_APPROVAL_LINE.SetSelectParamValue("W_DEPT_ID", vObject_DEPT_ID);
                                        idaDOC_APPROVAL_LINE.Fill();

                                        //재경 결재라인//
                                        IDA_DOC_APPROVAL_LINE_FI.SetSelectParamValue("W_STD_DATE", vObject_GL_DATE);
        ...
        private void FCMF0216_Load(object sender, EventArgs e)
        {
