...
namespace FCMF0873
{
    public class XLPrinting
    {
        ...
        private int mIncrementCopyMAX = 28;  //복사되어질 행의 범위

        private int mCopyColumnSTART = 1; //복사되어  진 행 누적 수
        private int mCopyColumnEND = 51;  //엑셀의 선택된 쉬트의 복사되어질 끝 열 위치
        ...
        private void SetArray1(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid, out int[] pGDColumn, out int[] pXLColumn)
        {
            ...
            pGDColumn[1] = pGrid.GetColumnToIndex("DOC_NAME"); //서류명
            pGDColumn[2] = pGrid.GetColumnToIndex("PUBLISHER"); //발급자
            pGDColumn[3] = pGrid.GetColumnToIndex("PRINT_PUBLISH_DATE"); //출력_발급일자
            pGDColumn[4] = pGrid.GetColumnToIndex("PRINT_SHIPPING_DATE"); //출력_선적일자
            pGDColumn[5] = pGrid.GetColumnToIndex("CURRENCY_CODE"); //통화
            pGDColumn[6] = pGrid.GetColumnToIndex("EXCHANGE_RATE"); //환율
            pGDColumn[7] = pGrid.GetColumnToIndex("SUBMIT_FOREIGN_AMT"); //당기제출외화
            pGDColumn[8] = pGrid.GetColumnToIndex("SUBMIT_KOREAN_AMT"); //당기제출원화
            pGDColumn[9] = pGrid.GetColumnToIndex("REPORT_FOREIGN_AMT"); //당기신고외화
            pGDColumn[10] = pGrid.GetColumnToIndex("REPORT_KOREAN_AMT"); //당기신고원화


            pXLColumn[0] = 2;   //출력_일련번호
            pXLColumn[1] = 4;   //서류명
            pXLColumn[2] = 9;   //발급자
            pXLColumn[3] = 13;  //출력_발급일자
            pXLColumn[4] = 16;  //출력_선적일자
            pXLColumn[5] = 19;  //통화
            pXLColumn[6] = 21;  //환율
            pXLColumn[7] = 25;  //당기제출외화
            pXLColumn[8] = 31;  //당기제출원화
            pXLColumn[9] = 37;  //당기신고외화
            pXLColumn[10] = 43; //당기신고원화
        }
        ...
        {
            int vPrintingLineEND = mCopyLineSUM - 2; //1~28: mCopyLineSUM=29에서 내용이 출력되는 행이 27 까지 이므로, 2을 빼면 된다
