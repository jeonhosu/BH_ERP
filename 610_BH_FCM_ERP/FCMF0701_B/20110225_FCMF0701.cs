...
namespace FCMF0701
{
    public partial class FCMF0701 : Office2007Form
    {
        ...
        private void XLPrinting1()
        {
            ...
            try
            {
                ...
                if (IsOpen == true)
                {
                    ...
                    string vPeriod = PERIOD_NAME_0.EditValue.ToString();

                    int vTerritory = GetTerritory(igrTRIAL_BALANCE.TerritoryLanguage);
                    ...
                    string vHeaderCenter = FORM_TYPE_NAME_0.EditValue.ToString();

                    vPageNumber = xlPrinting.XLWirte(igrTRIAL_BALANCE, vTerritory, vHeaderCenter, vPeriod, vUserName, vCaption);
        ...
        private void SearchDB()
        {
            ...
            {
                MessageBoxAdv.Show(isMessageAdapter1.ReturnText("FCM_10156"), "Waring", MessageBoxButtons.OK, MessageBoxIcon.Warning);
