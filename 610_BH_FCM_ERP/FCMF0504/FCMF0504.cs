...
namespace FCMF0504
{
    public partial class FCMF0504 : Office2007Form
    {
        ...
        private void SearchDB()
        {
            ...
            if (iString.ISNull(MANAGEMENT_VALUE_0.EditValue) == string.Empty)
            {
                MessageBoxAdv.Show(isMessageAdapter1.ReturnText("EAPP_90004", "&&FIELD_NAME:=Management Value(관리항목 값)"), "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                MANAGEMENT_DESC_0.Focus();
                return;
            }
