...
namespace FCMF0761
{
    public class XLPrinting
    {
        ...
        public int LineWrite(InfoSummit.Win.ControlAdv.ISGridAdvEx p_grid_FACTORY_COST_YEAR, InfoSummit.Win.ControlAdv.ISDataAdapter p_adapter_PRINT_TITLE)
        {
            mPageNumber = 0;
            ...
            try
            {
                int vTotal1ROW = p_grid_FACTORY_COST_YEAR.RowCount;
                ...
                if (vTotal1ROW > 0)
                {
                    ...
                    SetArray1(p_grid_FACTORY_COST_YEAR, out vGDColumn, out vXLColumn);
                    ...
                    for (int vRow1 = 0; vRow1 < vTotal1ROW; vRow1++)
                    {
                        ...
                        vPrintingLine = XLLine(p_grid_FACTORY_COST_YEAR, vRow1, vPrintingLine, vGDColumn, vXLColumn);
