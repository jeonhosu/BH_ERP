...
namespace FCMF0503
{
    ...
    public class XLPrinting04
    {
        ...
        private bool mIsFirstPastPrinted = false; //첫번째 페이지 출력 했는지?
        ...
        public XLPrinting04(InfoSummit.Win.ControlAdv.ISAppInterfaceAdv pIsAppInterFace, InfoSummit.Win.ControlAdv.ISMessageAdapter pIsMessageAdapter)
        {
        ...
        {
            if (mIsFirstPastPrinted == false)
            {
                mPrinting.XLActiveSheet("SourceTab1"); //mPrinting.XLActiveSheet(2);
            }
            else
            {
                mPrinting.XLActiveSheet("SourceTab2"); //mPrinting.XLActiveSheet(2);
            }
