...
namespace FCMF0205
{
    public class XLPrinting
    {
        ...
        public void HeaderWrite(InfoSummit.Win.ControlAdv.ISDataAdapter pDataAdapter)
        {
            object vObject = null;
            try
            {
                ...
                //전표번호[GL_NUM]
                vObject = pDataAdapter.CurrentRow["GL_NUM"];
                if (vObject != null)
                {
                ...
                //작성일자[SLIP_DATE]
                vObject = pDataAdapter.CurrentRow["SLIP_DATE"];
                if (vObject != null)
                {
                ...
                //작성부서명[DEPT_NAME]
                vObject = pDataAdapter.CurrentRow["DEPT_NAME"];
                if (vObject != null)
                {
                ...
                //작성자 이름[PERSON_NAME]
                vObject = pDataAdapter.CurrentRow["PERSON_NAME"];
                if (vObject != null)
                {
                ...
                //회계일자[GL_DATE]
                vObject = pDataAdapter.CurrentRow["GL_DATE"];
                if (vObject != null)
                {
                    vObject = ConvertDate(vObject);
                ...
                //기표번호[GL_NUM]
                vObject = pDataAdapter.CurrentRow["SLIP_NUM"];
                if (vObject != null)
                {
