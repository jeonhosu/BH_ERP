...
namespace FCMF0205
{
    public partial class FCMF0205 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0205(Form pMainForm, ISAppInterface pAppInterface, object pSLIP_HEADER_ID)
        {
            InitializeComponent();
        ...
        {// 계정의 관리항목 정보.
            ...
            {
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_ID"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER1_ID"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_ID"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER2_ID"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_ID"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER3_ID"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_ID"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER4_ID"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_ID"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER5_ID"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_ID"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER6_ID"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_ID"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER7_ID"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_ID"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER8_ID"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_ID"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER9_ID"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_ID"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER10_ID"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER9_ID"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER11_ID"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER10_ID"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER12_ID"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER11_ID"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER13_ID"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER12_ID"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER14_ID"]);

                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER1_NAME"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER2_NAME"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER3_NAME"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER4_NAME"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER5_NAME"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER6_NAME"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER7_NAME"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER8_NAME"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER9_NAME"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER10_NAME"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER9_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER11_NAME"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER10_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER12_NAME"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER11_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER13_NAME"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER12_NAME"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER14_NAME"]);                                

                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER1_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER2_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER3_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER4_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER5_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER6_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER7_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER8_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER9_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER10_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER9_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER11_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER10_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER12_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER11_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER13_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER12_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER14_YN"]);

                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_DR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER1_DR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_DR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER2_DR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_DR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER3_DR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_DR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER4_DR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_DR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER5_DR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_DR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER6_DR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_DR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER7_DR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_DR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER8_DR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_DR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER9_DR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_DR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER10_DR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER9_DR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER11_DR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER10_DR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER12_DR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER11_DR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER13_DR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER12_DR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER14_DR_YN"]);


                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_CR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER1_CR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_CR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER2_CR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_CR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER3_CR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_CR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER4_CR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_CR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER5_CR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_CR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER6_CR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_CR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER7_CR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_CR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER8_CR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_CR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER9_CR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_CR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER10_CR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER9_CR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER11_CR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER10_CR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER12_CR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER11_CR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER13_CR_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER12_CR_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER14_CR_YN"]);

                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER1_LOOKUP_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER2_LOOKUP_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER3_LOOKUP_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER4_LOOKUP_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER5_LOOKUP_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER6_LOOKUP_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER7_LOOKUP_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER8_LOOKUP_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER9_LOOKUP_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER10_LOOKUP_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER9_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER11_LOOKUP_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER10_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER12_LOOKUP_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER11_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER13_LOOKUP_YN"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER12_LOOKUP_YN"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER14_LOOKUP_YN"]);

                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER1_LOOKUP_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER2_LOOKUP_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER3_LOOKUP_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER4_LOOKUP_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER5_LOOKUP_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER6_LOOKUP_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER7_LOOKUP_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER8_LOOKUP_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER9_LOOKUP_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER10_LOOKUP_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER9_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER11_LOOKUP_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER10_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER12_LOOKUP_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER11_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER13_LOOKUP_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER12_LOOKUP_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER14_LOOKUP_TYPE"]);

                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER1_DATA_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER2_DATA_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER3_DATA_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER4_DATA_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER5_DATA_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER6_DATA_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER7_DATA_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER8_DATA_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER9_DATA_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER10_DATA_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER9_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER11_DATA_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER10_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER12_DATA_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER11_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER13_DATA_TYPE"]);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER12_DATA_TYPE"), idaCONTROL_ITEM_PROMPT.CurrentRow["REFER14_DATA_TYPE"]);
            }
            else
            {
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_ID"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_ID"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_ID"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_ID"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_ID"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_ID"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_ID"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_ID"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_ID"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_ID"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER9_ID"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER10_ID"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER11_ID"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER12_ID"), null);
                ...
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER9_NAME"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER10_NAME"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER11_NAME"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER12_NAME"), null);
                ...
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER9_YN"), "F");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER10_YN"), "F");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER11_YN"), "F");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER12_YN"), "F");

                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_DR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_DR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_DR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_DR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_DR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_DR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_DR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_DR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_DR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_DR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER9_DR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER10_DR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER11_DR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER12_DR_YN"), "N");

                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT1_CR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("MANAGEMENT2_CR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER1_CR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER2_CR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER3_CR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER4_CR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER5_CR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER6_CR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER7_CR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER8_CR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER9_CR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER10_CR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER11_CR_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER12_CR_YN"), "N");
                ...
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER9_LOOKUP_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER10_LOOKUP_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER11_LOOKUP_YN"), "N");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER12_LOOKUP_YN"), "N");
                ...
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER9_LOOKUP_TYPE"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER10_LOOKUP_TYPE"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER11_LOOKUP_TYPE"), null);
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER12_LOOKUP_TYPE"), null);
                ...
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER9_DATA_TYPE"), "VARCHAR2");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER10_DATA_TYPE"), "VARCHAR2");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER11_DATA_TYPE"), "VARCHAR2");
                igrSLIP_LINE.SetCellValue(mCurrent_RowIndex, igrSLIP_LINE.GetColumnToIndex("REFER12_DATA_TYPE"), "VARCHAR2");
            }
        }
        ...
        private void XLPrinting1(string pOutChoice)
        {
            ...
            int vCountRowGrid = idaSLIP_HEADER.OraSelectData.Rows.Count;    //헤더 자료 존재 체크.
            if (vCountRowGrid > 0)
            {
                ...
                try
                {
                    ...
                    if (isOpen == true)
                    {
                        ...
                        object vObject_DEPT_ID = H_DEPT_ID.EditValue; 
        ...
        private void isAppInterfaceAdv1_AppMainButtonClick(ISAppButtonEvents e)
        {
            if (this.IsActive)
            {
                ...
                {                    
                    ...
                    {
                        MessageBoxAdv.Show(ex.Message, "Warnin", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
                }
        ...
        private void FCMF0205_Load(object sender, EventArgs e)
        {
            idaSLIP_HEADER.FillSchema();
        }

        private void FCMF0205_Shown(object sender, EventArgs e)
        {
            mSLIP_QUERY_STATUS = "QUERY";
            // 회계장부 정보 설정.
            GetAccountBook();
        ...
        private void btnSUB_FORM_ButtonClick(object pSender, EventArgs pEventArgs)
        {
            ...
            //    Form vFCMF0206_BILL_MASTER = new FCMF0205_BILL_MASTER(isAppInterfaceAdv1.AppInterface, igrBILL_MASTER);
            ...
            if (iString.ISNull(ACCOUNT_CLASS_TYPE.EditValue) == "LIQUIDATE".ToString())
            {
                ...
                Form vFCMF0205_UNLIQUIDATE_LIST = new FCMF0205_UNLIQUIDATE_LIST(isAppInterfaceAdv1.AppInterface, idaUNLIQUIDATE_LIST
                ...
                dlgResultValue = vFCMF0205_UNLIQUIDATE_LIST.ShowDialog();
                if (dlgResultValue == DialogResult.OK)
                {
                    this.Cursor = System.Windows.Forms.Cursors.WaitCursor;
                ...
                vFCMF0205_UNLIQUIDATE_LIST.Dispose();                
            }
            else if (iString.ISNull(ACCOUNT_CLASS_TYPE.EditValue) == "AP_VAT".ToString())
            {
                ...
                {
                    // 건물등 감가상각 취득금액 표시.
                    mSUPPLY_AMOUNT = vFCMF0205_ASSET.Get_SUP_AMOUNT;
                    mTAX_AMOUNT = vFCMF0205_ASSET.Get_TAX_AMOUNT;
                    mCOUNT = vFCMF0205_ASSET.Get_ASSET_COUNT;
        ...
        {
            if (SLIP_DATE.DataAdapter.IsFillCompleted == true)
            {
                GL_DATE.EditValue = SLIP_DATE.EditValue;
            }
        }
        ...
        private void idaSLIP_LINE_NewRowMoved(object pSender, ISBindingEventArgs pBindingManager)
        {
            ...
            Init_Currency_Amount();
            GetSubForm();
            if (mSLIP_QUERY_STATUS.ToString() != "QUERY".ToString())
            {
                Init_DR_CR_Amount();
            }
            Init_Total_GL_Amount();
