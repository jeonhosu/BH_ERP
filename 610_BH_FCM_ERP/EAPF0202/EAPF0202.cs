...
namespace EAPF0202
{
    public partial class EAPF0202 : Office2007Form
    {
        ...
        private void idaEXCHANGE_RATE_PreRowUpdate(ISPreRowUpdateEventArgs e)
        {
            ...
            if (Convert.ToInt32(e.Row["SELLING_RATE"]) < Convert.ToInt32(0))
            {
            ...
            if (Convert.ToInt32(e.Row["BUYING_RATE"]) < Convert.ToInt32(0))
            {
                MessageBoxAdv.Show(isMessageAdapter1.ReturnText("EAPP_10039"), "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                e.Cancel = true;
                return;
            ...
            if (Convert.ToInt32(e.Row["BASE_RATE"]) < Convert.ToInt32(0))
            {
                MessageBoxAdv.Show(isMessageAdapter1.ReturnText("EAPP_10039"), "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                e.Cancel = true;
                return;
