...
namespace FCMF0215
{
    public partial class FCMF0215 : Office2007Form
    {
        ...
        object mAccount_Book_ID = null;
        object mAccount_Set_ID = null;
        object mFiscal_Calendar_ID = null;
        object mDept_Level = null;
        object mAccount_Book_Name = null;
        object mCurrency_Code = null;
        object mBudget_Control_YN = null;
        ...
        private void XLPrinting_1(string pOutChoice)
        {
            ...
            {
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "FCMF0215_001.xls";
                //-------------------------------------------------------------------------------------
                ...
                if (isOpen == true)
                {
                    ...
                    object vObject_HEADER_INTERFACE_ID = igrSLIP_LIST_IF.GetCellValue("HEADER_INTERFACE_ID");
                    object vObject_DEPT_ID = igrSLIP_LIST_IF.GetCellValue("DEPT_ID");
                    if (iString.ISNull(H_SLIP_HEADER_ID.EditValue) != string.Empty)
                    {
                        vObject_HEADER_INTERFACE_ID = H_SLIP_HEADER_ID.EditValue;
                    ...
                    idaPRINT_SLIP_LINE.SetSelectParamValue("W_SLIP_HEADER_INTERFACE_ID", vObject_HEADER_INTERFACE_ID);
        ...
        private void FCMF0215_Shown(object sender, EventArgs e)
        {
            ...
            //SLIP_DATE_FR_0.EditValue = new System.DateTime(2011, 09, 01);
            //SLIP_DATE_TO_0.EditValue = new System.DateTime(2011, 09, 30);
            //SLIP_HEADER_NUM_0.EditValue = "GL-20110920-00012";
        }
        ...
        private void ilaBUDGET_DEPT_PrePopupShow_1(object pSender, ISLookupPopupShowEventArgs e)
        {
        ...
        private void idaSLIP_HEADER_PreRowUpdate(ISPreRowUpdateEventArgs e)
        {
            ...
            if (iString.ISNull(SLIP_NUM.EditValue) == string.Empty ||
                iString.ISNull(e.Row["SLIP_DATE"]).Replace("-", "").Substring(0, 8) != iString.ISNull(e.Row["SLIP_NUM"]).Substring(3, 8))
            {
                GetSlipNum();
            }
