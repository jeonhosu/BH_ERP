    ...
    public class XLPrinting
    {
        ...
        {// pGridRow : 그리드의 현재 읽는 행, pXLine : 엑셀의 인쇄해야 하는 행. pGDColumn : 그리드 위치, pXLColumn : 엑셀 위치.
            ...
            { // 원본을 복사해서 타겟 에 복사해 넣음.(
                ...
                // 외화금액 합계;
                mTOT_CURR_AMOUNT = mTOT_CURR_AMOUNT + vConvertDecimal;
                //6 - 원화금액
                ...
                // 원화금액 합계;
                mTOT_BASE_AMOUNT = mTOT_BASE_AMOUNT + vConvertDecimal;
                //-------------------------------------------------------------------
                vXLine = vXLine + 1;
                //-------------------------------------------------------------------
            }
                ...
                if (vTotalRow > 0)
                {
                    ...
                    for (int vRow = 0; vRow < vTotalRow; vRow++)
                    {
                        ...
                        if (vRow == vTotalRow - 1)
                        {
                            ...
                            mCurrentRow = XLTOTAL_Line(10);     //합계.
                            mCurrentRow = XLTOTAL_Line(11);     // 수출재화 합계.
                        }
                        else
                        {
