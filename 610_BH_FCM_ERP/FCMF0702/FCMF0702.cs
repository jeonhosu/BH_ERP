...
namespace FCMF0702
{
    public partial class FCMF0702 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0702(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void ExportXL(ISGridAdvEx pGrid)
        {
            ...
            if (vCountRows > 0)
            {
                ...
                if (saveFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    string vOpenExcelFileName = "FCMF0702_002.xls";
        ...
        private void XLPrinting(InfoSummit.Win.ControlAdv.ISGridAdvEx pGrid)
        {
            ...
            if (vCountRowGrid > 0)
            {
                ...
                {
                    //-------------------------------------------------------------------------------------
                    xlPrinting.OpenFileNameExcel = "FCMF0702_001.xls";
                    //-------------------------------------------------------------------------------------
        ...
        private void FCMF0702_Load(object sender, EventArgs e)
        {
        ...
        private void FCMF0702_Shown(object sender, EventArgs e)
        {
