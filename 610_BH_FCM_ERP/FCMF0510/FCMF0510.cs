...
namespace FCMF0510
{
    public partial class FCMF0510 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0510(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void FCMF0510_Load(object sender, EventArgs e)
        {
            DefaultSetDate1();
        }
        ...
        private void isTabAdv1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                isGridAdvEx1.Focus();
                isDataAdapter2.IsFocused = false;
            }
            else if (vIndexTab == 1)
            {
                isGridAdvEx2.Focus();
