...
namespace FCMF0362
{
    public partial class FCMF0362 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public FCMF0362(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void FCMF0362_Load(object sender, EventArgs e)
        {
        ...
        private void igrASSET_MASTER_CellMoved(object pSender, ISGridAdvExCellClickEventArgs e)
        {
            Search_DB_HISTORY();
