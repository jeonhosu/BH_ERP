...
namespace SOMF0644
{
    public partial class SOMF0644 : Office2007Form
    {
        ...
        public SOMF0644(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        {
            V_RECEIPT_DATE_FR.EditValue = iDate.ISMonth_1st(DateTime.Today);
            V_RECEIPT_DATE_TO.EditValue = DateTime.Today;
