...
namespace SOMF0614
{
    public partial class SOMF0614 : Office2007Form
    {
        ...
        public SOMF0614(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void SOMF0614_Load(object sender, EventArgs e) //출고일자에 초기값 설정
        {
