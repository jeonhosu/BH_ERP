...
namespace PPMF0606
{
    public partial class PPMF0606 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public PPMF0606(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        {// pOutChoice : 출력구분.
            ...
            {// 폼에 있는 항목들중 기본적으로 출력해야 하는 값.
                ...
                // open해야 할 파일명 지정.
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "PPMF0606_001.xls";
                //-------------------------------------------------------------------------------------
                // 파일 오픈.
                //-------------------------------------------------------------------------------------
        ...
        private void isAppInterfaceAdv1_AppMainButtonClick(ISAppButtonEvents e)
        {
            if (this.IsActive)
            {
                ...
                {
                    XLPrinting_1("PRINT", igrSFG_LIST);
                }
                else if (e.AppMainButtonType == ISUtil.Enum.AppMainButtonType.Export)
                {
                    XLPrinting_1("FILE", igrSFG_LIST);
                }
            }
        }
        ...
        private void PPMF0606_Load(object sender, EventArgs e)
        {

        }

        private void PPMF0606_Shown(object sender, EventArgs e)
        {
            Default_Value();
        }
