...
namespace PPMF0602
{
    public partial class PPMF0602 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public PPMF0602(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        {// pOutChoice : 출력구분.
            ...
            {// 폼에 있는 항목들중 기본적으로 출력해야 하는 값.
                ...
                // open해야 할 파일명 지정.
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "PPMF0602_001.xls";
                //-------------------------------------------------------------------------------------
                // 파일 오픈.
                //-------------------------------------------------------------------------------------
        ...
        private void isAppInterfaceAdv1_AppMainButtonClick(ISAppButtonEvents e)
        {
            if (this.IsActive)
            {
                ...
                {
                    XLPrinting_1("PRINT", igrWIP_LIST);
                }
                else if (e.AppMainButtonType == ISUtil.Enum.AppMainButtonType.Export)
                {
                    XLPrinting_1("FILE", igrWIP_LIST);
                }
            }
        }
        ...
        private void PPMF0602_Load(object sender, EventArgs e)
        {

        }

        private void PPMF0602_Shown(object sender, EventArgs e)
        {
            Default_Value();
        }
