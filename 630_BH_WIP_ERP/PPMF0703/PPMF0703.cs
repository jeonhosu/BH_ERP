...
namespace PPMF0703
{
    public partial class PPMF0703 : Office2007Form
    {
        #region ----- Variables -----
        ...
        public PPMF0703(Form pMainForm, ISAppInterface pAppInterface)
        {
            InitializeComponent();
        ...
        private void SEARCH_DB()
        {
            ...
            idaFIELD_WAREHOUSE.Fill();
            igrFIELD_WAREHOUSE.Focus();
        }
        ...
        {// pOutChoice : 출력구분.
            ...
            {// 폼에 있는 항목들중 기본적으로 출력해야 하는 값.
                ...
                // open해야 할 파일명 지정.
                //-------------------------------------------------------------------------------------
                xlPrinting.OpenFileNameExcel = "PPMF0703_001.xls";
                //-------------------------------------------------------------------------------------
                // 파일 오픈.
                //-------------------------------------------------------------------------------------
        ...
        private void isAppInterfaceAdv1_AppMainButtonClick(ISAppButtonEvents e)
        {
            if (this.IsActive)
            {
                ...
                {
                    if (idaFIELD_WAREHOUSE.IsFocused)
                    {
                        idaFIELD_WAREHOUSE.Cancel();
                    }
                }
                else if (e.AppMainButtonType == ISUtil.Enum.AppMainButtonType.Delete)
                {
                    if (idaFIELD_WAREHOUSE.IsFocused)
                    {
                        idaFIELD_WAREHOUSE.Delete();
                    }
                }
                else if (e.AppMainButtonType == ISUtil.Enum.AppMainButtonType.Print)
                {
                    XLPrinting_1("PRINT", igrFIELD_WAREHOUSE);
                }
                else if (e.AppMainButtonType == ISUtil.Enum.AppMainButtonType.Export)
                {
                    XLPrinting_1("FILE", igrFIELD_WAREHOUSE);
                }
            }
        }
        ...
        private void PPMF0703_Load(object sender, EventArgs e)
        {

        }

        private void PPMF0703_Shown(object sender, EventArgs e)
        {
            Default_Value();
        }
