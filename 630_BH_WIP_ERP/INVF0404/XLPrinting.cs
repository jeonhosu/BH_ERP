...
namespace INVF0404
{
    public class XLPrinting
    {
        ...
        {// 그리드의 컬럼에 대한 컬럼인덱스 값 산출
            ...
            pGDColumn[1] = pGrid.GetColumnToIndex("SUMMARY_GROUP");
            pGDColumn[2] = pGrid.GetColumnToIndex("DESCRIPTION");
            pGDColumn[3] = pGrid.GetColumnToIndex("ITEM_CODE");
            pGDColumn[4] = pGrid.GetColumnToIndex("ITEM_DESCRIPTION");
            pGDColumn[5] = pGrid.GetColumnToIndex("MAKER_CODE");
            pGDColumn[6] = pGrid.GetColumnToIndex("MAKER_DESCRIPTION");
            pGDColumn[7] = pGrid.GetColumnToIndex("UOM_CODE");
            pGDColumn[8] = pGrid.GetColumnToIndex("ONHAND_QTY");
            pGDColumn[9] = pGrid.GetColumnToIndex("ACTUAL_QTY");
        ...
        private void XLHeader1(object pWORKCENTER_DESC)
        {// 헤더 인쇄.
